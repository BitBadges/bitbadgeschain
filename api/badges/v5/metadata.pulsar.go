...
func init() {
	...
	md_BadgeMetadata = File_badges_v5_metadata_proto.Messages().ByName("BadgeMetadata")
...
func (x *BadgeMetadata) slowProtoReflect() protoreflect.Message {
	mi := &file_badges_v5_metadata_proto_msgTypes[0]
...
func (x *fastReflection_BadgeMetadata) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "badges.v5.BadgeMetadata.uri":
		return x.Uri != ""
	case "badges.v5.BadgeMetadata.customData":
		return x.CustomData != ""
	case "badges.v5.BadgeMetadata.badgeIds":
		return len(x.BadgeIds) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: badges.v5.BadgeMetadata"))
		}
		panic(fmt.Errorf("message badges.v5.BadgeMetadata does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BadgeMetadata) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message badges.v5.BadgeMetadata does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BadgeMetadata) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "badges.v5.BadgeMetadata.uri":
		panic(fmt.Errorf("field uri of message badges.v5.BadgeMetadata is not mutable"))
	case "badges.v5.BadgeMetadata.customData":
		panic(fmt.Errorf("field customData of message badges.v5.BadgeMetadata is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: badges.v5.BadgeMetadata"))
		}
...
func (x *fastReflection_BadgeMetadata) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in badges.v5.BadgeMetadata", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_badges_v5_metadata_proto_init()
	md_CollectionMetadata = File_badges_v5_metadata_proto.Messages().ByName("CollectionMetadata")
...
func (x *CollectionMetadata) slowProtoReflect() protoreflect.Message {
	mi := &file_badges_v5_metadata_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_CollectionMetadata) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "badges.v5.CollectionMetadata.uri":
		return x.Uri != ""
	case "badges.v5.CollectionMetadata.customData":
		return x.CustomData != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: badges.v5.CollectionMetadata"))
		}
		panic(fmt.Errorf("message badges.v5.CollectionMetadata does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CollectionMetadata) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message badges.v5.CollectionMetadata does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CollectionMetadata) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "badges.v5.CollectionMetadata.uri":
		panic(fmt.Errorf("field uri of message badges.v5.CollectionMetadata is not mutable"))
	case "badges.v5.CollectionMetadata.customData":
		panic(fmt.Errorf("field customData of message badges.v5.CollectionMetadata is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: badges.v5.CollectionMetadata"))
		}
...
func (x *fastReflection_CollectionMetadata) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in badges.v5.CollectionMetadata", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_badges_v5_metadata_proto_init()
	md_OffChainBalancesMetadata = File_badges_v5_metadata_proto.Messages().ByName("OffChainBalancesMetadata")
...
func (x *OffChainBalancesMetadata) slowProtoReflect() protoreflect.Message {
	mi := &file_badges_v5_metadata_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_OffChainBalancesMetadata) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "badges.v5.OffChainBalancesMetadata.uri":
		return x.Uri != ""
	case "badges.v5.OffChainBalancesMetadata.customData":
		return x.CustomData != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: badges.v5.OffChainBalancesMetadata"))
		}
		panic(fmt.Errorf("message badges.v5.OffChainBalancesMetadata does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_OffChainBalancesMetadata) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message badges.v5.OffChainBalancesMetadata does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_OffChainBalancesMetadata) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "badges.v5.OffChainBalancesMetadata.uri":
		panic(fmt.Errorf("field uri of message badges.v5.OffChainBalancesMetadata is not mutable"))
	case "badges.v5.OffChainBalancesMetadata.customData":
		panic(fmt.Errorf("field customData of message badges.v5.OffChainBalancesMetadata is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: badges.v5.OffChainBalancesMetadata"))
		}
...
func (x *fastReflection_OffChainBalancesMetadata) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in badges.v5.OffChainBalancesMetadata", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: badges/v5/metadata.proto
...
func (*BadgeMetadata) Descriptor() ([]byte, []int) {
	return file_badges_v5_metadata_proto_rawDescGZIP(), []int{0}
}
...
func (*CollectionMetadata) Descriptor() ([]byte, []int) {
	return file_badges_v5_metadata_proto_rawDescGZIP(), []int{1}
}
...
func (*OffChainBalancesMetadata) Descriptor() ([]byte, []int) {
	return file_badges_v5_metadata_proto_rawDescGZIP(), []int{2}
}
...
var File_badges_v5_metadata_proto protoreflect.FileDescriptor

var file_badges_v5_metadata_proto_rawDesc = []byte{
	0x0a, 0x18, 0x62, 0x61, 0x64, 0x67, 0x65, 0x73, 0x2f, 0x76, 0x35, 0x2f, 0x6d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x62, 0x61, 0x64, 0x67,
	0x65, 0x73, 0x2e, 0x76, 0x35, 0x1a, 0x19, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72,
	...
	0x35, 0x2e, 0x55, 0x69, 0x6e, 0x74, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x08, 0x62, 0x61, 0x64,
	...
	0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x61, 0x64, 0x67, 0x65, 0x73, 0x2e, 0x76, 0x35, 0x42, 0x0d, 0x4d,
	...
	0x70, 0x69, 0x2f, 0x62, 0x61, 0x64, 0x67, 0x65, 0x73, 0x2f, 0x76, 0x35, 0x3b, 0x62, 0x61, 0x64,
	0x67, 0x65, 0x73, 0x76, 0x35, 0xa2, 0x02, 0x03, 0x42, 0x58, 0x58, 0xaa, 0x02, 0x09, 0x42, 0x61,
	0x64, 0x67, 0x65, 0x73, 0x2e, 0x56, 0x35, 0xca, 0x02, 0x09, 0x42, 0x61, 0x64, 0x67, 0x65, 0x73,
	0x5c, 0x56, 0x35, 0xe2, 0x02, 0x15, 0x42, 0x61, 0x64, 0x67, 0x65, 0x73, 0x5c, 0x56, 0x35, 0x5c,
	0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0a, 0x42, 0x61,
	0x64, 0x67, 0x65, 0x73, 0x3a, 0x3a, 0x56, 0x35, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_badges_v5_metadata_proto_rawDescOnce sync.Once
	file_badges_v5_metadata_proto_rawDescData = file_badges_v5_metadata_proto_rawDesc
)

func file_badges_v5_metadata_proto_rawDescGZIP() []byte {
	file_badges_v5_metadata_proto_rawDescOnce.Do(func() {
		file_badges_v5_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(file_badges_v5_metadata_proto_rawDescData)
	})
	return file_badges_v5_metadata_proto_rawDescData
}

var file_badges_v5_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_badges_v5_metadata_proto_goTypes = []interface{}{
	(*BadgeMetadata)(nil),            // 0: badges.v5.BadgeMetadata
	(*CollectionMetadata)(nil),       // 1: badges.v5.CollectionMetadata
	(*OffChainBalancesMetadata)(nil), // 2: badges.v5.OffChainBalancesMetadata
	(*UintRange)(nil),                // 3: badges.v5.UintRange
}
var file_badges_v5_metadata_proto_depIdxs = []int32{
	3, // 0: badges.v5.BadgeMetadata.badgeIds:type_name -> badges.v5.UintRange
...
func init() { file_badges_v5_metadata_proto_init() }
func file_badges_v5_metadata_proto_init() {
	if File_badges_v5_metadata_proto != nil {
		return
	}
	file_badges_v5_balances_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_badges_v5_metadata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_badges_v5_metadata_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_badges_v5_metadata_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_badges_v5_metadata_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_badges_v5_metadata_proto_goTypes,
		DependencyIndexes: file_badges_v5_metadata_proto_depIdxs,
		MessageInfos:      file_badges_v5_metadata_proto_msgTypes,
	}.Build()
	File_badges_v5_metadata_proto = out.File
	file_badges_v5_metadata_proto_rawDesc = nil
	file_badges_v5_metadata_proto_goTypes = nil
	file_badges_v5_metadata_proto_depIdxs = nil
}
