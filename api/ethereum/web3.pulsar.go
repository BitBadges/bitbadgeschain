...
func init() {
	file_ethereum_web3_proto_init()
	md_ExtensionOptionsWeb3Tx = File_ethereum_web3_proto.Messages().ByName("ExtensionOptionsWeb3Tx")
...
func (x *ExtensionOptionsWeb3Tx) slowProtoReflect() protoreflect.Message {
	mi := &file_ethereum_web3_proto_msgTypes[0]
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ethereum.ExtensionOptionsWeb3Tx.typed_data_chain_id":
		return x.TypedDataChainId != uint64(0)
	case "ethereum.ExtensionOptionsWeb3Tx.fee_payer":
		return x.FeePayer != ""
	case "ethereum.ExtensionOptionsWeb3Tx.fee_payer_sig":
		return len(x.FeePayerSig) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ethereum.ExtensionOptionsWeb3Tx"))
		}
		panic(fmt.Errorf("message ethereum.ExtensionOptionsWeb3Tx does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message ethereum.ExtensionOptionsWeb3Tx does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "ethereum.ExtensionOptionsWeb3Tx.typed_data_chain_id":
		panic(fmt.Errorf("field typed_data_chain_id of message ethereum.ExtensionOptionsWeb3Tx is not mutable"))
	case "ethereum.ExtensionOptionsWeb3Tx.fee_payer":
		panic(fmt.Errorf("field fee_payer of message ethereum.ExtensionOptionsWeb3Tx is not mutable"))
	case "ethereum.ExtensionOptionsWeb3Tx.fee_payer_sig":
		panic(fmt.Errorf("field fee_payer_sig of message ethereum.ExtensionOptionsWeb3Tx is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ethereum.ExtensionOptionsWeb3Tx"))
		}
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in ethereum.ExtensionOptionsWeb3Tx", d.FullName()))
	}
	panic("unreachable")
}
...
func (*ExtensionOptionsWeb3Tx) Descriptor() ([]byte, []int) {
	return file_ethereum_web3_proto_rawDescGZIP(), []int{0}
}
...
var File_ethereum_web3_proto protoreflect.FileDescriptor

var file_ethereum_web3_proto_rawDesc = []byte{
	0x0a, 0x13, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2f, 0x77, 0x65, 0x62, 0x33, 0x2e,
	...
	,
}

var (
	file_ethereum_web3_proto_rawDescOnce sync.Once
	file_ethereum_web3_proto_rawDescData = file_ethereum_web3_proto_rawDesc
)

func file_ethereum_web3_proto_rawDescGZIP() []byte {
	file_ethereum_web3_proto_rawDescOnce.Do(func() {
		file_ethereum_web3_proto_rawDescData = protoimpl.X.CompressGZIP(file_ethereum_web3_proto_rawDescData)
	})
	return file_ethereum_web3_proto_rawDescData
}

var file_ethereum_web3_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ethereum_web3_proto_goTypes = []interface{}{
	(*ExtensionOptionsWeb3Tx)(nil), // 0: ethereum.ExtensionOptionsWeb3Tx
}
var file_ethereum_web3_proto_depIdxs = []int32{
...
func init() { file_ethereum_web3_proto_init() }
func file_ethereum_web3_proto_init() {
	if File_ethereum_web3_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ethereum_web3_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ethereum_web3_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ethereum_web3_proto_goTypes,
		DependencyIndexes: file_ethereum_web3_proto_depIdxs,
		MessageInfos:      file_ethereum_web3_proto_msgTypes,
	}.Build()
	File_ethereum_web3_proto = out.File
	file_ethereum_web3_proto_rawDesc = nil
	file_ethereum_web3_proto_goTypes = nil
	file_ethereum_web3_proto_depIdxs = nil
}
