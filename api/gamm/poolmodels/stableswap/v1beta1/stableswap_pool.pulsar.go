...
func init() {
	...
	md_PoolParams = File_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto.Messages().ByName("PoolParams")
...
func (x *PoolParams) slowProtoReflect() protoreflect.Message {
	mi := &file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_msgTypes[0]
...
func (x *fastReflection_PoolParams) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "gamm.poolmodels.stableswap.PoolParams.swap_fee":
		return x.SwapFee != ""
	case "gamm.poolmodels.stableswap.PoolParams.exit_fee":
		return x.ExitFee != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: gamm.poolmodels.stableswap.PoolParams"))
		}
		panic(fmt.Errorf("message gamm.poolmodels.stableswap.PoolParams does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PoolParams) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message gamm.poolmodels.stableswap.PoolParams does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PoolParams) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "gamm.poolmodels.stableswap.PoolParams.swap_fee":
		panic(fmt.Errorf("field swap_fee of message gamm.poolmodels.stableswap.PoolParams is not mutable"))
	case "gamm.poolmodels.stableswap.PoolParams.exit_fee":
		panic(fmt.Errorf("field exit_fee of message gamm.poolmodels.stableswap.PoolParams is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: gamm.poolmodels.stableswap.PoolParams"))
		}
...
func (x *fastReflection_PoolParams) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in gamm.poolmodels.stableswap.PoolParams", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_init()
	md_Pool = File_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto.Messages().ByName("Pool")
...
func (x *Pool) slowProtoReflect() protoreflect.Message {
	mi := &file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Pool) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "gamm.poolmodels.stableswap.Pool.address":
		return x.Address != ""
	case "gamm.poolmodels.stableswap.Pool.id":
		return x.Id != uint64(0)
	case "gamm.poolmodels.stableswap.Pool.pool_params":
		return x.PoolParams != nil
	case "gamm.poolmodels.stableswap.Pool.future_pool_governor":
		return x.FuturePoolGovernor != ""
	case "gamm.poolmodels.stableswap.Pool.total_shares":
		return x.TotalShares != nil
	case "gamm.poolmodels.stableswap.Pool.pool_liquidity":
		return len(x.PoolLiquidity) != 0
	case "gamm.poolmodels.stableswap.Pool.scaling_factors":
		return len(x.ScalingFactors) != 0
	case "gamm.poolmodels.stableswap.Pool.scaling_factor_controller":
		return x.ScalingFactorController != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: gamm.poolmodels.stableswap.Pool"))
		}
		panic(fmt.Errorf("message gamm.poolmodels.stableswap.Pool does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Pool) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message gamm.poolmodels.stableswap.Pool does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Pool) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "gamm.poolmodels.stableswap.Pool.scaling_factors":
		...
		return protoreflect.ValueOfList(value)
	case "gamm.poolmodels.stableswap.Pool.address":
		panic(fmt.Errorf("field address of message gamm.poolmodels.stableswap.Pool is not mutable"))
	case "gamm.poolmodels.stableswap.Pool.id":
		panic(fmt.Errorf("field id of message gamm.poolmodels.stableswap.Pool is not mutable"))
	case "gamm.poolmodels.stableswap.Pool.future_pool_governor":
		panic(fmt.Errorf("field future_pool_governor of message gamm.poolmodels.stableswap.Pool is not mutable"))
	case "gamm.poolmodels.stableswap.Pool.scaling_factor_controller":
		panic(fmt.Errorf("field scaling_factor_controller of message gamm.poolmodels.stableswap.Pool is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: gamm.poolmodels.stableswap.Pool"))
		}
...
func (x *fastReflection_Pool) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in gamm.poolmodels.stableswap.Pool", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: gamm/poolmodels/stableswap/v1beta1/stableswap_pool.proto
...
func (*PoolParams) Descriptor() ([]byte, []int) {
	return file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDescGZIP(), []int{0}
}
...
func (*Pool) Descriptor() ([]byte, []int) {
	return file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDescGZIP(), []int{1}
}
...
var File_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto protoreflect.FileDescriptor

var file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDesc = []byte{
	0x0a, 0x38, 0x67, 0x61, 0x6d, 0x6d, 0x2f, 0x70, 0x6f, 0x6f, 0x6c, 0x6d, 0x6f, 0x64, 0x65, 0x6c,
	0x73, 0x2f, 0x73, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x77, 0x61, 0x70, 0x2f, 0x76, 0x31, 0x62,
	0x65, 0x74, 0x61, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x77, 0x61, 0x70, 0x5f,
	0x70, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1a, 0x67, 0x61, 0x6d, 0x6d,
	0x2e, 0x70, 0x6f, 0x6f, 0x6c, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x73, 0x74, 0x61, 0x62,
	0x6c, 0x65, 0x73, 0x77, 0x61, 0x70, 0x1a, 0x19, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5f, 0x70,
	...
	0x2f, 0x63, 0x6f, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xda, 0x01, 0x0a, 0x0a,
	0x50, 0x6f, 0x6f, 0x6c, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x51, 0x0a, 0x08, 0x73, 0x77,
	0x61, 0x70, 0x5f, 0x66, 0x65, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x36, 0xc8, 0xde,
	...
	,
	...
	,
	...
	0x52, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x68, 0x61, 0x72, 0x65, 0x73, 0x12, 0x72, 0x0a,
	0x0e, 0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x18,
	...
	,
}

var (
	file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDescOnce sync.Once
	file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDescData = file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDesc
)

func file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDescGZIP() []byte {
	file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDescOnce.Do(func() {
		file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDescData = protoimpl.X.CompressGZIP(file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDescData)
	})
	return file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDescData
}

var file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_goTypes = []interface{}{
	(*PoolParams)(nil),   // 0: gamm.poolmodels.stableswap.PoolParams
	(*Pool)(nil),         // 1: gamm.poolmodels.stableswap.Pool
	(*v1beta1.Coin)(nil), // 2: cosmos.base.v1beta1.Coin
}
var file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_depIdxs = []int32{
	0, // 0: gamm.poolmodels.stableswap.Pool.pool_params:type_name -> gamm.poolmodels.stableswap.PoolParams
	2, // 1: gamm.poolmodels.stableswap.Pool.total_shares:type_name -> cosmos.base.v1beta1.Coin
	2, // 2: gamm.poolmodels.stableswap.Pool.pool_liquidity:type_name -> cosmos.base.v1beta1.Coin
...
func init() { file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_init() }
func file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_init() {
	if File_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pool); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_goTypes,
		DependencyIndexes: file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_depIdxs,
		MessageInfos:      file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_msgTypes,
	}.Build()
	File_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto = out.File
	file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_rawDesc = nil
	file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_goTypes = nil
	file_gamm_poolmodels_stableswap_v1beta1_stableswap_pool_proto_depIdxs = nil
}
