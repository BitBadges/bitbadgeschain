...
const (
	Query_Params_FullMethodName      = "/offers.Query/Params"
	Query_GetProposal_FullMethodName = "/offers.Query/GetProposal"
)
...
func (UnimplementedQueryServer) GetProposal(context.Context, *QueryGetProposalRequest) (*QueryGetProposalResponse, error) {
