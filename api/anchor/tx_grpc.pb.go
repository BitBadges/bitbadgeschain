...
const (
	Msg_UpdateParams_FullMethodName  = "/anchor.Msg/UpdateParams"
	Msg_AddCustomData_FullMethodName = "/anchor.Msg/AddCustomData"
)
...
func (c *msgClient) AddCustomData(ctx context.Context, in *MsgAddCustomData, opts ...grpc.CallOption) (*MsgAddCustomDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_AddCustomData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) AddCustomData(context.Context, *MsgAddCustomData) (*MsgAddCustomDataResponse, error) {
...
func _Msg_AddCustomData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_AddCustomData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
