...
const (
	Query_Params_FullMethodName             = "/anchor.Query/Params"
	Query_GetValueAtLocation_FullMethodName = "/anchor.Query/GetValueAtLocation"
)
...
func (c *queryClient) GetValueAtLocation(ctx context.Context, in *QueryGetValueAtLocationRequest, opts ...grpc.CallOption) (*QueryGetValueAtLocationResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetValueAtLocation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) GetValueAtLocation(context.Context, *QueryGetValueAtLocationRequest) (*QueryGetValueAtLocationResponse, error) {
...
func _Query_GetValueAtLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_GetValueAtLocation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
