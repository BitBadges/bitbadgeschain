...
replace (
	github.com/CosmWasm/wasmd => github.com/notional-labs/wasmd v1.0.69
	github.com/InjectiveLabs/injective-core => github.com/OpenDeFiFoundation/injective-core v0.0.0-20230317153015-c6137d530bc9
