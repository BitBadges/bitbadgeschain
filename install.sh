...
#   curl -fsSL https://raw.githubusercontent.com/BitBadges/bitbadgeschain/main/install.sh | sh -s -- --version v28
#
# Options:
...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    --help)
      ...
      echo ""
      echo "Usage: curl -fsSL https://raw.githubusercontent.com/BitBadges/bitbadgeschain/main/install.sh | sh"
      echo ""
      echo "Options:"
