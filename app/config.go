...
const (
	// ChainID is the chain ID for the BitBadges chain
	ChainID = "bitbadges-1"
	// BaseDenom is the base denom for the BitBadges chain
	BaseDenom = "ubadge"
	// DisplayDenom is the display denom for the BitBadges chain
	DisplayDenom = "badge"
)
