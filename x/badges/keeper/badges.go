...
func CreateSubassets(badge types.BitBadge, managerBalanceInfo types.UserBalanceInfo, supplysAndAmounts []*types.SubassetSupplyAndAmount) (types.BitBadge, types.UserBalanceInfo, error) {
