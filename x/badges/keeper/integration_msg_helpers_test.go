...
func ClaimBadge(suite *TestSuite, ctx context.Context, creator string, claimId uint64, collectionId uint64, proof *types.Proof, uri string, timeRange *types.IdRange) error {
