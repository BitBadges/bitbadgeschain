	...
	err = UpdateCollectionApprovals(suite, wctx, &types.MsgUniversalUpdateCollectionApprovals{
		...
		CollectionApprovals: []*types.CollectionApproval{
			...
			},
			{
				...
				OwnershipTimes:       GetFullUintRanges(),
				ApprovalId:           "testdfgh",
				AmountTrackerId:      "testdfgh",
				ChallengeTrackerId:   "testdfgh",
				ApprovalCriteria:     collectionsToCreate[0].CollectionApprovals[1].ApprovalCriteria,
			},
		},
	})
	...
	err = UpdateCollectionApprovals(suite, wctx, &types.MsgUniversalUpdateCollectionApprovals{
		...
		CollectionApprovals: []*types.CollectionApproval{
			collectionsToCreate[0].CollectionApprovals[0],
			{
				...
				AmountTrackerId: 		"something different",
			},
			{
				FromListId:        "!" + alice,
				ToListId:          "AllWithoutMint",
	...
	err = UpdateCollectionApprovals(suite, wctx, &types.MsgUniversalUpdateCollectionApprovals{
		...
		CollectionApprovals: []*types.CollectionApproval{
			...
			},
			{
				...
				AmountTrackerId:      "testadsfasdf",
				ChallengeTrackerId:   "testadsfasdf",
				ApprovalCriteria:     collectionsToCreate[0].CollectionApprovals[1].ApprovalCriteria,
			},
		},
	})
	...
	err = UpdateCollectionApprovals(suite, wctx, &types.MsgUniversalUpdateCollectionApprovals{
		...
		CollectionApprovals: []*types.CollectionApproval{
			...
			},
			{
				...
				AmountTrackerId:      "testasdfasd",
				ChallengeTrackerId:   "testasdfasd",
				ApprovalCriteria:     collectionsToCreate[0].CollectionApprovals[1].ApprovalCriteria,
			},
		},
	})
	...
	err = UpdateCollectionApprovals(suite, wctx, &types.MsgUniversalUpdateCollectionApprovals{
		...
		CollectionApprovals: []*types.CollectionApproval{
			...
			},
			{
				...
				OwnershipTimes:       GetFullUintRanges(),
				ApprovalId:           "testgfag",
				AmountTrackerId:      "testgfag",
				ChallengeTrackerId:   "testgfag",
				ApprovalCriteria:     newApprovalCriteria,
			},
		},
	})
	...
	err = UpdateCollectionApprovals(suite, wctx, &types.MsgUniversalUpdateCollectionApprovals{
		...
		CollectionApprovals: []*types.CollectionApproval{
			...
			},
			{
				...
				OwnershipTimes:       GetFullUintRanges(),
				ApprovalId:           "testagdf",
				AmountTrackerId:      "testagdf",
				ChallengeTrackerId:   "testagdf",
				ApprovalCriteria:     newApprovalCriteria,
			},
		},
	})
	...
	err = UpdateCollectionApprovals(suite, wctx, &types.MsgUniversalUpdateCollectionApprovals{
		...
		CollectionApprovals: []*types.CollectionApproval{
			...
			},
			{
				...
				AmountTrackerId:      "testadfgsd",
				ChallengeTrackerId:   "testadfgsd",
				ApprovalCriteria:     newApprovalCriteria,
			},
		},
	})
	...
	err = UpdateCollectionApprovals(suite, wctx, &types.MsgUniversalUpdateCollectionApprovals{
		...
		CollectionApprovals: []*types.CollectionApproval{
			...
			},
			{
				...
				AmountTrackerId:      "testsgdfs",
				ChallengeTrackerId:   "testsgdfs",
				ApprovalCriteria:     newApprovalCriteria,
			},
		},
	})
	...
	err = UpdateCollectionApprovals(suite, wctx, &types.MsgUniversalUpdateCollectionApprovals{
		...
		CollectionApprovals: []*types.CollectionApproval{
			...
			},
			{
				...
				AmountTrackerId:      "testsdfgsdf",
				ChallengeTrackerId:   "testsdfgsdf",
				ApprovalCriteria:     newApprovalCriteria,
			},
		},
	})
	...
	err = UpdateCollectionApprovals(suite, wctx, &types.MsgUniversalUpdateCollectionApprovals{
		...
		CollectionApprovals: []*types.CollectionApproval{
			...
			},
			{
				...
				ChallengeTrackerId:   "adsfhjaladsfasdf",
				ApprovalCriteria: &types.ApprovalCriteria{
