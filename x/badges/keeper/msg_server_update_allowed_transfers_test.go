...
// // 		},
// // 	}, badge.MaxSupplys)
// // 	suite.Require().Equal(sdkmath.NewUint(10000), keeper.GetBalancesForIds([]*types.IdRange{{Start: sdkmath.NewUint(1), End: sdkmath.NewUint(1)}}, bobbalance.Balances)[0].Amount)
