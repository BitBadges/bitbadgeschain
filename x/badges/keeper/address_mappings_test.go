...
func (suite *TestSuite) TestReservedIds() {
	...
	toCheck := []string{"Mint", "Manager", "!dadsf", "122:323", "1asdsdfa:1234", "All", "None", alice, bob, charlie}
	...
	autoFetched := []string{"Mint", "Manager", "122:323", "All", "None", alice, bob, charlie}
