...
// the specified addresses (depending on if onlySpecifiedAddresses is true or false).
//
...
type AddressMapping struct {
	...
	OnlySpecifiedAddresses bool     `protobuf:"varint,3,opt,name=onlySpecifiedAddresses,proto3" json:"onlySpecifiedAddresses,omitempty"`
...
func (m *AddressMapping) GetOnlySpecifiedAddresses() bool {
	if m != nil {
		return m.OnlySpecifiedAddresses
	}
	return false
}
...
var fileDescriptor_02934262277c144c = []byte{
	...
	0x5e, 0x72, 0x2a, 0xd4, 0x34, 0xa5, 0x6d, 0x8c, 0x5c, 0x7c, 0x8e, 0x10, 0x8b, 0x7c, 0x21, 0xf6,
	...
	0xcc, 0xb8, 0xc4, 0xf2, 0xf3, 0x72, 0x2a, 0x83, 0x0b, 0x52, 0x93, 0x33, 0xd3, 0x32, 0x53, 0x53,
	0x1c, 0xe1, 0x4a, 0x99, 0x15, 0x18, 0x35, 0x38, 0x82, 0x70, 0xc8, 0x0a, 0x09, 0x70, 0x31, 0x97,
	0x16, 0x65, 0x4a, 0xb0, 0x80, 0x6d, 0x03, 0x31, 0x85, 0xe4, 0xb8, 0xb8, 0x92, 0x4b, 0x8b, 0x4b,
	0xf2, 0x73, 0x5d, 0x12, 0x4b, 0x12, 0x25, 0x58, 0xc1, 0x12, 0x48, 0x22, 0x4e, 0x3e, 0x27, 0x1e,
	...
	0x97, 0x9c, 0x9f, 0xab, 0x0f, 0x0f, 0x21, 0x7d, 0xd4, 0xb0, 0xd2, 0xaf, 0xd0, 0x87, 0x8a, 0x97,
	0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x43, 0xc3, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xdb,
	0xfb, 0x7d, 0x28, 0x7c, 0x01, 0x00, 0x00,
}
...
func (m *AddressMapping) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnlySpecifiedAddresses", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OnlySpecifiedAddresses = bool(v != 0)
		case 4:
			if wireType != 2 {
