...
var (
	...
	ErrRangesOverlap                               = sdkerrors.Register(ModuleName, 1530, "id ranges are not allowed to overlap. for example, { Start: sdkmath.NewUint(1), end: 5 } and { Start:   sdkmath.NewUint(4), End: sdkmath.NewUint(1)0 } overlap")
