...
func NewMsgTransferBadge(creator string, from uint64, toAddresses []uint64, amounts []uint64, badgeId uint64, subbadgeRanges []*NumberRange, expirationTime uint64) *MsgTransferBadge {
