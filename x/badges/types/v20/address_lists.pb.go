...
// source: badges/v20/address_lists.proto
...
func (*AddressList) Descriptor() ([]byte, []int) {
	return fileDescriptor_eb5d7dfaf8883ed4, []int{0}
}
...
func init() {
	proto.RegisterType((*AddressList)(nil), "badges.v20.AddressList")
}

func init() { proto.RegisterFile("badges/v20/address_lists.proto", fileDescriptor_eb5d7dfaf8883ed4) }

var fileDescriptor_eb5d7dfaf8883ed4 = []byte{
	...
	0x61, 0x04, 0xf7, 0x0e, 0x6e, 0x04, 0x17, 0xd2, 0xa5, 0x1b, 0x49, 0x9b, 0xd0, 0x06, 0x66, 0x26,
	...
	0x71, 0xfb, 0x1b, 0x00, 0x00, 0xff, 0xff, 0x58, 0x9d, 0x0a, 0xdb, 0x6b, 0x01, 0x00, 0x00,
}
