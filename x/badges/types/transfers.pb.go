...
type UserBalanceStore struct {
	...
	ApprovedTransfers     []*UserApprovedTransfer `protobuf:"bytes,2,rep,name=approvedTransfers,proto3" json:"approvedTransfers,omitempty"`
...
func (m *UserBalanceStore) GetApprovedTransfers() []*UserApprovedTransfer {
	if m != nil {
...
type IsTransferAllowed struct {
	...
	InvertTimeIntervals bool `protobuf:"varint,4,opt,name=invertTimeIntervals,proto3" json:"invertTimeIntervals,omitempty"`
...
func (m *IsTransferAllowed) GetInvertTimeIntervals() bool {
	if m != nil {
		return m.InvertTimeIntervals
	}
	return false
}
...
type UserApprovedTransfer struct {
	...
	TransferTrackerId Uint `protobuf:"bytes,8,opt,name=transferTrackerId,proto3,customtype=Uint" json:"transferTrackerId"`
...
func (m *IsCollectionTransferAllowed) GetInvertTimeIntervals() bool {
	if m != nil {
		return m.InvertTimeIntervals
	}
	return false
...
var fileDescriptor_db7d8388ebf2a03f = []byte{
	...
	,
}
...
func (m *IsTransferAllowed) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InvertTimeIntervals", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InvertTimeIntervals = bool(v != 0)
		case 5:
			if wireType != 0 {
