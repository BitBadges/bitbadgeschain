...
// source: badges/v21/timelines.proto
...
func (*CollectionMetadataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_5b38825ce19603fd, []int{0}
}
...
func (*TokenMetadataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_5b38825ce19603fd, []int{1}
}
...
func (*CustomDataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_5b38825ce19603fd, []int{2}
}
...
func (*ManagerTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_5b38825ce19603fd, []int{3}
}
...
func (*IsArchivedTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_5b38825ce19603fd, []int{4}
}
...
func (*ContractAddressTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_5b38825ce19603fd, []int{5}
}
...
func (*StandardsTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_5b38825ce19603fd, []int{6}
}
...
func init() {
	proto.RegisterType((*CollectionMetadataTimeline)(nil), "badges.v21.CollectionMetadataTimeline")
	proto.RegisterType((*TokenMetadataTimeline)(nil), "badges.v21.TokenMetadataTimeline")
	proto.RegisterType((*CustomDataTimeline)(nil), "badges.v21.CustomDataTimeline")
	proto.RegisterType((*ManagerTimeline)(nil), "badges.v21.ManagerTimeline")
	proto.RegisterType((*IsArchivedTimeline)(nil), "badges.v21.IsArchivedTimeline")
	proto.RegisterType((*ContractAddressTimeline)(nil), "badges.v21.ContractAddressTimeline")
	proto.RegisterType((*StandardsTimeline)(nil), "badges.v21.StandardsTimeline")
}

func init() { proto.RegisterFile("badges/v21/timelines.proto", fileDescriptor_5b38825ce19603fd) }

var fileDescriptor_5b38825ce19603fd = []byte{
	...
	0xc5, 0xea, 0x21, 0xb1, 0x30, 0xa0, 0x72, 0x2c, 0x0c, 0x45, 0x28, 0x94, 0x85, 0xcd, 0x71, 0x5c,
	...
	0x73, 0xfd, 0xd9, 0xa3, 0xfa, 0xbe, 0x5f, 0xfc, 0x0b, 0x00, 0x00, 0xff, 0xff, 0x08, 0xdb, 0x67,
	0x20, 0xaa, 0x04, 0x00, 0x00,
}
