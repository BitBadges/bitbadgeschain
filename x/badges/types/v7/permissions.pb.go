...
// source: badges/v7/permissions.proto
...
func (*CollectionPermissions) Descriptor() ([]byte, []int) {
	return fileDescriptor_0768a88f80b6a1b6, []int{0}
}
...
func (*UserPermissions) Descriptor() ([]byte, []int) {
	return fileDescriptor_0768a88f80b6a1b6, []int{1}
}
...
func (*CollectionApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0768a88f80b6a1b6, []int{2}
}
...
func (*UserOutgoingApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0768a88f80b6a1b6, []int{3}
}
...
func (*UserIncomingApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0768a88f80b6a1b6, []int{4}
}
...
func (*BadgeIdsActionPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0768a88f80b6a1b6, []int{5}
}
...
func (*ActionPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0768a88f80b6a1b6, []int{6}
}
...
func (*TimedUpdatePermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0768a88f80b6a1b6, []int{7}
}
...
func (*TimedUpdateWithBadgeIdsPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0768a88f80b6a1b6, []int{8}
}
...
func init() {
	proto.RegisterType((*CollectionPermissions)(nil), "badges.v7.CollectionPermissions")
	proto.RegisterType((*UserPermissions)(nil), "badges.v7.UserPermissions")
	proto.RegisterType((*CollectionApprovalPermission)(nil), "badges.v7.CollectionApprovalPermission")
	proto.RegisterType((*UserOutgoingApprovalPermission)(nil), "badges.v7.UserOutgoingApprovalPermission")
	proto.RegisterType((*UserIncomingApprovalPermission)(nil), "badges.v7.UserIncomingApprovalPermission")
	proto.RegisterType((*BadgeIdsActionPermission)(nil), "badges.v7.BadgeIdsActionPermission")
	proto.RegisterType((*ActionPermission)(nil), "badges.v7.ActionPermission")
	proto.RegisterType((*TimedUpdatePermission)(nil), "badges.v7.TimedUpdatePermission")
	proto.RegisterType((*TimedUpdateWithBadgeIdsPermission)(nil), "badges.v7.TimedUpdateWithBadgeIdsPermission")
}

func init() { proto.RegisterFile("badges/v7/permissions.proto", fileDescriptor_0768a88f80b6a1b6) }

var fileDescriptor_0768a88f80b6a1b6 = []byte{
	...
	0x52, 0x15, 0xa3, 0x22, 0x54, 0x09, 0xb1, 0x49, 0x5a, 0x21, 0x45, 0x6a, 0xd5, 0x2a, 0x6d, 0x41,
	...
	0x25, 0xd9, 0x9d, 0x43, 0xd4, 0x10, 0x00, 0x00,
}
