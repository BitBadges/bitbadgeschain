...
type Proof struct {
	...
	LeafHash string   `protobuf:"bytes,3,opt,name=leafHash,proto3" json:"leafHash,omitempty"`
...
func (m *Proof) GetLeafHash() string {
	if m != nil {
		return m.LeafHash
	}
	return ""
...
type MsgClaimBadge struct {
	...
	Leaf         string `protobuf:"bytes,4,opt,name=leaf,proto3" json:"leaf,omitempty"`
...
func (m *MsgClaimBadge) GetLeaf() string {
	if m != nil {
		return m.Leaf
	}
	return ""
...
var fileDescriptor_bc897b33479788c9 = []byte{
	...
	,
}
