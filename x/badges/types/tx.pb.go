...
type BadgeCustomMsgType struct {
	...
	UnwrapIBCDenomMsg         *MsgUnwrapIBCDenom         `protobuf:"bytes,27,opt,name=unwrapIBCDenomMsg,proto3" json:"unwrapIBCDenomMsg,omitempty"`
}
...
func (m *BadgeCustomMsgType) GetUnwrapIBCDenomMsg() *MsgUnwrapIBCDenom {
	if m != nil {
		return m.UnwrapIBCDenomMsg
	}
	return nil
}
...
func (m *CosmosCoinWrapperPathAddObject) GetDenomSuffixDetails() *DenomSuffixDetails {
	if m != nil {
...
type IBCUnwrapPathAddObject struct {
...
func (m *IBCUnwrapPathAddObject) Reset()         { *m = IBCUnwrapPathAddObject{} }
func (m *IBCUnwrapPathAddObject) String() string { return proto.CompactTextString(m) }
func (*IBCUnwrapPathAddObject) ProtoMessage()    {}
func (*IBCUnwrapPathAddObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc897b33479788c9, []int{4}
}
func (m *IBCUnwrapPathAddObject) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IBCUnwrapPathAddObject) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IBCUnwrapPathAddObject.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IBCUnwrapPathAddObject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IBCUnwrapPathAddObject.Merge(m, src)
}
func (m *IBCUnwrapPathAddObject) XXX_Size() int {
	return m.Size()
}
func (m *IBCUnwrapPathAddObject) XXX_DiscardUnknown() {
	xxx_messageInfo_IBCUnwrapPathAddObject.DiscardUnknown(m)
}

var xxx_messageInfo_IBCUnwrapPathAddObject proto.InternalMessageInfo

func (m *IBCUnwrapPathAddObject) GetChannelId() string {
	if m != nil {
		return m.ChannelId
	}
	return ""
...
func (m *IBCUnwrapPathAddObject) GetPortId() string {
	if m != nil {
		return m.PortId
	}
	return ""
...
func (m *IBCUnwrapPathAddObject) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *IBCUnwrapPathAddObject) GetAllowOverrideWithAnyValidToken() bool {
	if m != nil {
		return m.AllowOverrideWithAnyValidToken
	}
	return false
...
func (m *IBCUnwrapPathAddObject) GetBalances() []*Balance {
	if m != nil {
		return m.Balances
	}
	return nil
...
func (m *IBCUnwrapPathAddObject) GetDenomSuffixDetails() *DenomSuffixDetails {
	if m != nil {
		return m.DenomSuffixDetails
	}
	return nil
...
type MsgUniversalUpdateCollection struct {
	...
	// IBC unwrap paths to add.
	IbcUnwrapPathsToAdd []*IBCUnwrapPathAddObject `protobuf:"bytes,30,rep,name=ibcUnwrapPathsToAdd,proto3" json:"ibcUnwrapPathsToAdd,omitempty"`
...
func (m *MsgUniversalUpdateCollection) GetIbcUnwrapPathsToAdd() []*IBCUnwrapPathAddObject {
	if m != nil {
		return m.IbcUnwrapPathsToAdd
	}
	return nil
}
...
type MsgUpdateCollection struct {
	...
	// IBC unwrap paths to add.
	IbcUnwrapPathsToAdd []*IBCUnwrapPathAddObject `protobuf:"bytes,32,rep,name=ibcUnwrapPathsToAdd,proto3" json:"ibcUnwrapPathsToAdd,omitempty"`
	// Collection-level invariants that cannot be broken.
	// These are set upon genesis and cannot be modified.
...
func (m *MsgUpdateCollection) GetIbcUnwrapPathsToAdd() []*IBCUnwrapPathAddObject {
	if m != nil {
		return m.IbcUnwrapPathsToAdd
	}
	return nil
...
type MsgCreateCollection struct {
	...
	// IBC unwrap paths to add.
	IbcUnwrapPathsToAdd []*IBCUnwrapPathAddObject `protobuf:"bytes,19,rep,name=ibcUnwrapPathsToAdd,proto3" json:"ibcUnwrapPathsToAdd,omitempty"`
	// Collection-level invariants that cannot be broken.
...
func (m *MsgCreateCollection) GetIbcUnwrapPathsToAdd() []*IBCUnwrapPathAddObject {
	if m != nil {
		return m.IbcUnwrapPathsToAdd
	}
	return nil
...
func (*MsgSetIsArchivedResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc897b33479788c9, []int{56}
}
...
// MsgUnwrapIBCDenom is used to unwrap IBC tokens back to badges.
type MsgUnwrapIBCDenom struct {
	// Address of the creator.
	Creator string `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	// ID of the collection.
	CollectionId Uint `protobuf:"bytes,2,opt,name=collectionId,proto3,customtype=Uint" json:"collectionId"`
	// The IBC token to unwrap (expected to be ibc/SHA256 format).
	Amount *types.Coin `protobuf:"bytes,3,opt,name=amount,proto3" json:"amount,omitempty"`
	// Override token ID to replace {id} placeholders in path denom.
	// Used when AllowOverrideWithAnyValidToken is true.
	OverrideTokenId string `protobuf:"bytes,4,opt,name=overrideTokenId,proto3" json:"overrideTokenId,omitempty"`
}

func (m *MsgUnwrapIBCDenom) Reset()         { *m = MsgUnwrapIBCDenom{} }
func (m *MsgUnwrapIBCDenom) String() string { return proto.CompactTextString(m) }
func (*MsgUnwrapIBCDenom) ProtoMessage()    {}
func (*MsgUnwrapIBCDenom) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc897b33479788c9, []int{57}
}
func (m *MsgUnwrapIBCDenom) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgUnwrapIBCDenom) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgUnwrapIBCDenom.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgUnwrapIBCDenom) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgUnwrapIBCDenom.Merge(m, src)
}
func (m *MsgUnwrapIBCDenom) XXX_Size() int {
	return m.Size()
}
func (m *MsgUnwrapIBCDenom) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgUnwrapIBCDenom.DiscardUnknown(m)
}

var xxx_messageInfo_MsgUnwrapIBCDenom proto.InternalMessageInfo

func (m *MsgUnwrapIBCDenom) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *MsgUnwrapIBCDenom) GetAmount() *types.Coin {
	if m != nil {
		return m.Amount
	}
	return nil
...
func (m *MsgUnwrapIBCDenom) GetOverrideTokenId() string {
	if m != nil {
		return m.OverrideTokenId
	}
	return ""
}

// MsgUnwrapIBCDenomResponse is the response to MsgUnwrapIBCDenom.
type MsgUnwrapIBCDenomResponse struct {
}

func (m *MsgUnwrapIBCDenomResponse) Reset()         { *m = MsgUnwrapIBCDenomResponse{} }
func (m *MsgUnwrapIBCDenomResponse) String() string { return proto.CompactTextString(m) }
func (*MsgUnwrapIBCDenomResponse) ProtoMessage()    {}
func (*MsgUnwrapIBCDenomResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc897b33479788c9, []int{58}
}
func (m *MsgUnwrapIBCDenomResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgUnwrapIBCDenomResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgUnwrapIBCDenomResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgUnwrapIBCDenomResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgUnwrapIBCDenomResponse.Merge(m, src)
}
func (m *MsgUnwrapIBCDenomResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgUnwrapIBCDenomResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgUnwrapIBCDenomResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgUnwrapIBCDenomResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*IBCUnwrapPathAddObject)(nil), "badges.IBCUnwrapPathAddObject")
	...
	proto.RegisterType((*MsgUnwrapIBCDenom)(nil), "badges.MsgUnwrapIBCDenom")
	proto.RegisterType((*MsgUnwrapIBCDenomResponse)(nil), "badges.MsgUnwrapIBCDenomResponse")
}
...
var fileDescriptor_bc897b33479788c9 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	UnwrapIBCDenom(ctx context.Context, in *MsgUnwrapIBCDenom, opts ...grpc.CallOption) (*MsgUnwrapIBCDenomResponse, error)
	// Helper message types for UniversalUpdateCollection subsets
...
func (c *msgClient) IncrementStoreValue(ctx context.Context, in *MsgIncrementStoreValue, opts ...grpc.CallOption) (*MsgIncrementStoreValueResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/badges.Msg/IncrementStoreValue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DecrementStoreValue(ctx context.Context, in *MsgDecrementStoreValue, opts ...grpc.CallOption) (*MsgDecrementStoreValueResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/badges.Msg/DecrementStoreValue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UnwrapIBCDenom(ctx context.Context, in *MsgUnwrapIBCDenom, opts ...grpc.CallOption) (*MsgUnwrapIBCDenomResponse, error) {
	out := new(MsgUnwrapIBCDenomResponse)
	err := c.cc.Invoke(ctx, "/badges.Msg/UnwrapIBCDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	UnwrapIBCDenom(context.Context, *MsgUnwrapIBCDenom) (*MsgUnwrapIBCDenomResponse, error)
	// Helper message types for UniversalUpdateCollection subsets
...
func (*UnimplementedMsgServer) UnwrapIBCDenom(ctx context.Context, req *MsgUnwrapIBCDenom) (*MsgUnwrapIBCDenomResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnwrapIBCDenom not implemented")
}
...
func _Msg_IncrementStoreValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/badges.Msg/IncrementStoreValue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DecrementStoreValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/badges.Msg/DecrementStoreValue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UnwrapIBCDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgUnwrapIBCDenom)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).UnwrapIBCDenom(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/badges.Msg/UnwrapIBCDenom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).UnwrapIBCDenom(ctx, req.(*MsgUnwrapIBCDenom))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UnwrapIBCDenom",
			Handler:    _Msg_UnwrapIBCDenom_Handler,
		},
		{
...
func (m *BadgeCustomMsgType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.UnwrapIBCDenomMsg != nil {
		{
			size, err := m.UnwrapIBCDenomMsg.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *IBCUnwrapPathAddObject) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IBCUnwrapPathAddObject) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IBCUnwrapPathAddObject) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgUniversalUpdateCollection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.IbcUnwrapPathsToAdd) > 0 {
		for iNdEx := len(m.IbcUnwrapPathsToAdd) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.IbcUnwrapPathsToAdd[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MsgUnwrapIBCDenom) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgUnwrapIBCDenom) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgUnwrapIBCDenom) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.OverrideTokenId) > 0 {
		i -= len(m.OverrideTokenId)
		copy(dAtA[i:], m.OverrideTokenId)
		i = encodeVarintTx(dAtA, i, uint64(len(m.OverrideTokenId)))
		i--
		dAtA[i] = 0x22
	}
	if m.Amount != nil {
...
func (m *MsgUnwrapIBCDenomResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgUnwrapIBCDenomResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgUnwrapIBCDenomResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *IBCUnwrapPathAddObject) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgUniversalUpdateCollection) Size() (n int) {
	...
	if len(m.IbcUnwrapPathsToAdd) > 0 {
		for _, e := range m.IbcUnwrapPathsToAdd {
			l = e.Size()
			n += 2 + l + sovTx(uint64(l))
		}
	}
...
func (m *MsgUnwrapIBCDenom) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgUnwrapIBCDenomResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BadgeCustomMsgType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnwrapIBCDenomMsg", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UnwrapIBCDenomMsg == nil {
				m.UnwrapIBCDenomMsg = &MsgUnwrapIBCDenom{}
			}
			if err := m.UnwrapIBCDenomMsg.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *IBCUnwrapPathAddObject) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IBCUnwrapPathAddObject: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IBCUnwrapPathAddObject: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgUniversalUpdateCollection) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 30:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IbcUnwrapPathsToAdd", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IbcUnwrapPathsToAdd = append(m.IbcUnwrapPathsToAdd, &IBCUnwrapPathAddObject{})
			if err := m.IbcUnwrapPathsToAdd[len(m.IbcUnwrapPathsToAdd)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MsgUnwrapIBCDenom) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgUnwrapIBCDenom: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgUnwrapIBCDenom: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OverrideTokenId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OverrideTokenId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
...
func (m *MsgUnwrapIBCDenomResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgUnwrapIBCDenomResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgUnwrapIBCDenomResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
