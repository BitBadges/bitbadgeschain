...
type MsgHandlePendingTransfer struct {
	...
	StartingNonce uint64 `protobuf:"varint,5,opt,name=startingNonce,proto3" json:"startingNonce,omitempty"`
	EndingNonce   uint64 `protobuf:"varint,6,opt,name=endingNonce,proto3" json:"endingNonce,omitempty"`
}
...
func (m *MsgHandlePendingTransfer) GetStartingNonce() uint64 {
	if m != nil {
...
func (m *MsgHandlePendingTransfer) GetEndingNonce() uint64 {
	if m != nil {
		return m.EndingNonce
	}
	return 0
}
...
var fileDescriptor_bc897b33479788c9 = []byte{
	...
	,
}
...
func (m *MsgHandlePendingTransfer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.EndingNonce != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.EndingNonce))
		i--
		dAtA[i] = 0x30
	}
	if m.StartingNonce != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.StartingNonce))
		i--
		dAtA[i] = 0x28
	}
	if m.SubbadgeId != 0 {
...
func (m *MsgRevokeBadge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Amounts) > 0 {
		dAtA12 := make([]byte, len(m.Amounts)*10)
		var j11 int
		for _, num := range m.Amounts {
			for num >= 1<<7 {
...
func (m *MsgFreezeAddress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Addresses) > 0 {
		dAtA16 := make([]byte, len(m.Addresses)*10)
		var j15 int
		for _, num := range m.Addresses {
			for num >= 1<<7 {
...
func (m *MsgHandlePendingTransfer) Size() (n int) {
	...
	if m.StartingNonce != 0 {
		n += 1 + sovTx(uint64(m.StartingNonce))
	}
	if m.EndingNonce != 0 {
		n += 1 + sovTx(uint64(m.EndingNonce))
	}
	return n
}
...
func (m *MsgHandlePendingTransfer) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartingNonce", wireType)
			}
			m.StartingNonce = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StartingNonce |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EndingNonce", wireType)
			}
			m.EndingNonce = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EndingNonce |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
