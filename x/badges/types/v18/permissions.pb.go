...
func (*CollectionPermissions) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b2c3e8884e7b271, []int{0}
}
...
func (*UserPermissions) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b2c3e8884e7b271, []int{1}
}
...
func (*CollectionApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b2c3e8884e7b271, []int{2}
}
...
func (*UserOutgoingApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b2c3e8884e7b271, []int{3}
}
...
func (*UserIncomingApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b2c3e8884e7b271, []int{4}
}
...
func (*TokenIdsActionPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b2c3e8884e7b271, []int{5}
}
...
func (*ActionPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b2c3e8884e7b271, []int{6}
}
...
func (*TimedUpdatePermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b2c3e8884e7b271, []int{7}
}
...
func (*TimedUpdateWithTokenIdsPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b2c3e8884e7b271, []int{8}
}
...
func init() {
	proto.RegisterType((*CollectionPermissions)(nil), "badges.v18.CollectionPermissions")
	proto.RegisterType((*UserPermissions)(nil), "badges.v18.UserPermissions")
	proto.RegisterType((*CollectionApprovalPermission)(nil), "badges.v18.CollectionApprovalPermission")
	proto.RegisterType((*UserOutgoingApprovalPermission)(nil), "badges.v18.UserOutgoingApprovalPermission")
	proto.RegisterType((*UserIncomingApprovalPermission)(nil), "badges.v18.UserIncomingApprovalPermission")
	proto.RegisterType((*TokenIdsActionPermission)(nil), "badges.v18.TokenIdsActionPermission")
	proto.RegisterType((*ActionPermission)(nil), "badges.v18.ActionPermission")
	proto.RegisterType((*TimedUpdatePermission)(nil), "badges.v18.TimedUpdatePermission")
	proto.RegisterType((*TimedUpdateWithTokenIdsPermission)(nil), "badges.v18.TimedUpdateWithTokenIdsPermission")
}

func init() { proto.RegisterFile("badges/v18/permissions.proto", fileDescriptor_6b2c3e8884e7b271) }

var fileDescriptor_6b2c3e8884e7b271 = []byte{
	...
	0x10, 0x21, 0x88, 0xd5, 0x22, 0xa1, 0x4a, 0x88, 0x43, 0xda, 0x0a, 0x29, 0x12, 0x85, 0x92, 0xb4,
	...
	0xae, 0xf3, 0xeb, 0x40, 0x33, 0x67, 0x7f, 0xfa, 0xdf, 0xfb, 0x15, 0x00, 0x00, 0xff, 0xff, 0x8c,
	0x43, 0xbb, 0xe4, 0x92, 0x10, 0x00, 0x00,
}
