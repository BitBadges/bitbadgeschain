...
// source: badges/v15/address_lists.proto
...
func (*AddressList) Descriptor() ([]byte, []int) {
	return fileDescriptor_7b08df3e16f32e3a, []int{0}
}
...
func init() {
	proto.RegisterType((*AddressList)(nil), "badges.v15.AddressList")
}

func init() { proto.RegisterFile("badges/v15/address_lists.proto", fileDescriptor_7b08df3e16f32e3a) }

var fileDescriptor_7b08df3e16f32e3a = []byte{
	...
	0x06, 0x19, 0xf7, 0x0e, 0x6e, 0x04, 0x17, 0xd2, 0xa5, 0x1b, 0x49, 0x9b, 0xd0, 0x06, 0x66, 0x26,
	...
	0x71, 0xfb, 0x1b, 0x00, 0x00, 0xff, 0xff, 0xd0, 0x3d, 0x28, 0x19, 0x6b, 0x01, 0x00, 0x00,
}
