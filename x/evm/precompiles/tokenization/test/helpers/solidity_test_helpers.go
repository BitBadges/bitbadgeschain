...
// GetContractABI returns the ABI for the PrecompileTestContract
...
func GetContractABI() (abi.ABI, error) {
	...
	possiblePaths := []string{
		...
		filepath.Join("..", "..", "..", "..", "..", "..", abiPath), // From x/evm/precompiles/tokenization/test/integration
		filepath.Join("..", "..", "..", "..", abiPath),             // From x/evm/precompiles/tokenization
...
// GetContractBytecode returns the bytecode for the PrecompileTestContract
...
func GetContractBytecode() ([]byte, error) {
	...
	possiblePaths := []string{
		...
		filepath.Join("..", "..", "..", "..", "..", "..", bytecodePath), // From x/evm/precompiles/tokenization/test/integration
		filepath.Join("..", "..", "..", "..", bytecodePath),             // From x/evm/precompiles/tokenization
