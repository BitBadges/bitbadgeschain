...
import (
	...
	"github.com/bitbadges/bitbadgeschain/x/managersplitter/client/cli"
...
//
// Required for EIP-712 signature verification (cosmos/evm verifier amino-decodes
// the StdSignDoc messages on the chain's main legacy amino codec).
...
type ModuleOutputs struct {
	...
	ManagerSplitterKeeper keeper.Keeper
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	return ModuleOutputs{ManagerSplitterKeeper: k, Module: m}
}
