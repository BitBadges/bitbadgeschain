...
func CmdDeleteManagerSplitter() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "delete-manager-splitter [tx-json]",
		Short: "Broadcast message deleteManagerSplitter",
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			var txData types.MsgDeleteManagerSplitter
