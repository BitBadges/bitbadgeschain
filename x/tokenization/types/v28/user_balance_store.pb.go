...
// source: tokenization/v28/user_balance_store.proto
...
func (*UserBalanceStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0b47b34353a6120, []int{0}
}
...
func init() {
	proto.RegisterType((*UserBalanceStore)(nil), "tokenization.v28.UserBalanceStore")
}

func init() {
	proto.RegisterFile("tokenization/v28/user_balance_store.proto", fileDescriptor_e0b47b34353a6120)
}

var fileDescriptor_e0b47b34353a6120 = []byte{
	...
	0xa5, 0x4d, 0x6a, 0x4c, 0x18, 0x5c, 0x60, 0x92, 0x38, 0x68, 0x0a, 0x3a, 0x18, 0x13, 0x72, 0x2d,
	...
	0xff, 0xff, 0xf0, 0xd4, 0x07, 0x2a, 0x65, 0x03, 0x00, 0x00,
}
