...
// source: tokenization/v28/timelines.proto
...
func (*CollectionMetadataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_b03f5d93cdb17843, []int{0}
}
...
func (*TokenMetadataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_b03f5d93cdb17843, []int{1}
}
...
func (*CustomDataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_b03f5d93cdb17843, []int{2}
}
...
func (*ManagerTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_b03f5d93cdb17843, []int{3}
}
...
func (*IsArchivedTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_b03f5d93cdb17843, []int{4}
}
...
func (*ContractAddressTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_b03f5d93cdb17843, []int{5}
}
...
func (*StandardsTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_b03f5d93cdb17843, []int{6}
}
...
func init() {
	proto.RegisterType((*CollectionMetadataTimeline)(nil), "tokenization.v28.CollectionMetadataTimeline")
	proto.RegisterType((*TokenMetadataTimeline)(nil), "tokenization.v28.TokenMetadataTimeline")
	proto.RegisterType((*CustomDataTimeline)(nil), "tokenization.v28.CustomDataTimeline")
	proto.RegisterType((*ManagerTimeline)(nil), "tokenization.v28.ManagerTimeline")
	proto.RegisterType((*IsArchivedTimeline)(nil), "tokenization.v28.IsArchivedTimeline")
	proto.RegisterType((*ContractAddressTimeline)(nil), "tokenization.v28.ContractAddressTimeline")
	proto.RegisterType((*StandardsTimeline)(nil), "tokenization.v28.StandardsTimeline")
}

func init() { proto.RegisterFile("tokenization/v28/timelines.proto", fileDescriptor_b03f5d93cdb17843) }

var fileDescriptor_b03f5d93cdb17843 = []byte{
	...
	0xbc, 0x52, 0x68, 0xae, 0xa0, 0x09, 0x81, 0x82, 0xe2, 0x1a, 0x13, 0x28, 0xe8, 0xc6, 0xeb, 0xbd,
	...
	0xb8, 0x0d, 0xaf, 0xfe, 0x07, 0x00, 0x00, 0xff, 0xff, 0x48, 0xb5, 0x07, 0xe0, 0x0a, 0x05, 0x00,
	0x00,
}
