...
// source: tokenization/v31/timelines.proto
...
func (*CollectionMetadataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_94dea436d87d7268, []int{0}
}
...
func (*TokenMetadataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_94dea436d87d7268, []int{1}
}
...
func (*CustomDataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_94dea436d87d7268, []int{2}
}
...
func (*ManagerTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_94dea436d87d7268, []int{3}
}
...
func (*IsArchivedTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_94dea436d87d7268, []int{4}
}
...
func (*ContractAddressTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_94dea436d87d7268, []int{5}
}
...
func (*StandardsTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_94dea436d87d7268, []int{6}
}
...
func init() {
	proto.RegisterType((*CollectionMetadataTimeline)(nil), "tokenization.v31.CollectionMetadataTimeline")
	proto.RegisterType((*TokenMetadataTimeline)(nil), "tokenization.v31.TokenMetadataTimeline")
	proto.RegisterType((*CustomDataTimeline)(nil), "tokenization.v31.CustomDataTimeline")
	proto.RegisterType((*ManagerTimeline)(nil), "tokenization.v31.ManagerTimeline")
	proto.RegisterType((*IsArchivedTimeline)(nil), "tokenization.v31.IsArchivedTimeline")
	proto.RegisterType((*ContractAddressTimeline)(nil), "tokenization.v31.ContractAddressTimeline")
	proto.RegisterType((*StandardsTimeline)(nil), "tokenization.v31.StandardsTimeline")
}

func init() { proto.RegisterFile("tokenization/v31/timelines.proto", fileDescriptor_94dea436d87d7268) }

var fileDescriptor_94dea436d87d7268 = []byte{
	...
	0xbc, 0xba, 0x4b, 0x4b, 0x13, 0x02, 0x05, 0xc5, 0x35, 0x26, 0x50, 0xd0, 0x8d, 0xd7, 0x7b, 0x9b,
	...
	0x36, 0x4c, 0xfe, 0x05, 0x00, 0x00, 0xff, 0xff, 0xbe, 0x1c, 0x64, 0xb5, 0x0a, 0x05, 0x00, 0x00,
}
