...
// source: tokenization/v31/dynamic_stores.proto
...
func (*DynamicStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_175c62945a7aad35, []int{0}
}
...
func (*DynamicStoreValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_175c62945a7aad35, []int{1}
}
...
func init() {
	proto.RegisterType((*DynamicStore)(nil), "tokenization.v31.DynamicStore")
	proto.RegisterType((*DynamicStoreValue)(nil), "tokenization.v31.DynamicStoreValue")
}

func init() {
	proto.RegisterFile("tokenization/v31/dynamic_stores.proto", fileDescriptor_175c62945a7aad35)
}

var fileDescriptor_175c62945a7aad35 = []byte{
	...
	0x10, 0x5a, 0x2b, 0x82, 0x85, 0x2d, 0x46, 0x0a, 0x1b, 0xb3, 0x77, 0xbb, 0x1e, 0x1b, 0x8e, 0x5b,
	...
	0x29, 0x4d, 0x5a, 0xaa, 0x57, 0xb5, 0xf5, 0x0c, 0x7f, 0x03, 0x00, 0x00, 0xff, 0xff, 0x19, 0xb3,
	0x1b, 0x69, 0xef, 0x01, 0x00, 0x00,
}
