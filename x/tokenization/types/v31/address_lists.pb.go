...
// source: tokenization/v31/address_lists.proto
...
func (*AddressList) Descriptor() ([]byte, []int) {
	return fileDescriptor_3a6fda75a08e2650, []int{0}
}
...
func (*AddressListInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_3a6fda75a08e2650, []int{1}
}
...
func init() {
	proto.RegisterType((*AddressList)(nil), "tokenization.v31.AddressList")
	proto.RegisterType((*AddressListInput)(nil), "tokenization.v31.AddressListInput")
}

func init() {
	proto.RegisterFile("tokenization/v31/address_lists.proto", fileDescriptor_3a6fda75a08e2650)
}

var fileDescriptor_3a6fda75a08e2650 = []byte{
	...
	0x2c, 0x47, 0x5a, 0x1b, 0x0f, 0x9b, 0x03, 0xab, 0x14, 0x16, 0x36, 0xb2, 0x49, 0x96, 0x64, 0xf1,
	...
	0x00, 0xff, 0xff, 0x38, 0x90, 0x47, 0xcf, 0x1e, 0x02, 0x00, 0x00,
}
