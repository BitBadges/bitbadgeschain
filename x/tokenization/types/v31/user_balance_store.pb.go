...
// source: tokenization/v31/user_balance_store.proto
...
func (*UserBalanceStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_b0c04d6f908fd3a7, []int{0}
}
...
func init() {
	proto.RegisterType((*UserBalanceStore)(nil), "tokenization.v31.UserBalanceStore")
}

func init() {
	proto.RegisterFile("tokenization/v31/user_balance_store.proto", fileDescriptor_b0c04d6f908fd3a7)
}

var fileDescriptor_b0c04d6f908fd3a7 = []byte{
	...
	0x0d, 0x10, 0x37, 0x17, 0x98, 0x24, 0x0e, 0x9a, 0x82, 0x0e, 0xc6, 0x84, 0x5c, 0xcb, 0x51, 0x2e,
	...
	0x9f, 0x48, 0x99, 0xca, 0x65, 0x03, 0x00, 0x00,
}
