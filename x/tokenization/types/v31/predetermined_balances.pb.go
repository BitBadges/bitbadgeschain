...
// source: tokenization/v31/predetermined_balances.proto
...
func (*ManualBalances) Descriptor() ([]byte, []int) {
	return fileDescriptor_6889d4b4aac00b91, []int{0}
}
...
func (*RecurringOwnershipTimes) Descriptor() ([]byte, []int) {
	return fileDescriptor_6889d4b4aac00b91, []int{1}
}
...
func (*IncrementedBalances) Descriptor() ([]byte, []int) {
	return fileDescriptor_6889d4b4aac00b91, []int{2}
}
...
func (*PredeterminedOrderCalculationMethod) Descriptor() ([]byte, []int) {
	return fileDescriptor_6889d4b4aac00b91, []int{3}
}
...
func (*PredeterminedBalances) Descriptor() ([]byte, []int) {
	return fileDescriptor_6889d4b4aac00b91, []int{4}
}
...
func init() {
	proto.RegisterType((*ManualBalances)(nil), "tokenization.v31.ManualBalances")
	proto.RegisterType((*RecurringOwnershipTimes)(nil), "tokenization.v31.RecurringOwnershipTimes")
	proto.RegisterType((*IncrementedBalances)(nil), "tokenization.v31.IncrementedBalances")
	proto.RegisterType((*PredeterminedOrderCalculationMethod)(nil), "tokenization.v31.PredeterminedOrderCalculationMethod")
	proto.RegisterType((*PredeterminedBalances)(nil), "tokenization.v31.PredeterminedBalances")
}

func init() {
	proto.RegisterFile("tokenization/v31/predetermined_balances.proto", fileDescriptor_6889d4b4aac00b91)
}

var fileDescriptor_6889d4b4aac00b91 = []byte{
	...
	0x57, 0xca, 0x56, 0x6a, 0x22, 0x42, 0xe9, 0x15, 0x6a, 0x21, 0x54, 0xb4, 0xa9, 0x48, 0x41, 0x6e,
	...
	0xb5, 0xf6, 0x23, 0x00, 0x00, 0xff, 0xff, 0xbd, 0xed, 0x54, 0xd8, 0x5a, 0x07, 0x00, 0x00,
}
