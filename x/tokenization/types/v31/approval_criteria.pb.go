...
// source: tokenization/v31/approval_criteria.proto
...
func (*ApprovalCriteria) Descriptor() ([]byte, []int) {
	return fileDescriptor_b98ebeb573982bab, []int{0}
}
...
func (*OutgoingApprovalCriteria) Descriptor() ([]byte, []int) {
	return fileDescriptor_b98ebeb573982bab, []int{1}
}
...
func (*IncomingApprovalCriteria) Descriptor() ([]byte, []int) {
	return fileDescriptor_b98ebeb573982bab, []int{2}
}
...
func init() {
	proto.RegisterType((*ApprovalCriteria)(nil), "tokenization.v31.ApprovalCriteria")
	proto.RegisterType((*OutgoingApprovalCriteria)(nil), "tokenization.v31.OutgoingApprovalCriteria")
	proto.RegisterType((*IncomingApprovalCriteria)(nil), "tokenization.v31.IncomingApprovalCriteria")
}

func init() {
	proto.RegisterFile("tokenization/v31/approval_criteria.proto", fileDescriptor_b98ebeb573982bab)
}

var fileDescriptor_b98ebeb573982bab = []byte{
	...
	0xa8, 0x52, 0x6d, 0x01, 0xb7, 0x55, 0x25, 0x6c, 0x88, 0x4a, 0x2a, 0x43, 0xba, 0x76, 0x89, 0x14,
	...
	0x49, 0xda, 0xfd, 0x37, 0x00, 0x00, 0xff, 0xff, 0x76, 0x05, 0x6c, 0x2c, 0x45, 0x13, 0x00, 0x00,
}
