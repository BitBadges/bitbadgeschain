...
// source: tokenization/v25/approval_conditions.proto
...
func (*CoinTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_ea785983d34bd566, []int{0}
}
...
func (*MustOwnTokens) Descriptor() ([]byte, []int) {
	return fileDescriptor_ea785983d34bd566, []int{1}
}
...
func (*DynamicStoreChallenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_ea785983d34bd566, []int{2}
}
...
func (*AddressChecks) Descriptor() ([]byte, []int) {
	return fileDescriptor_ea785983d34bd566, []int{3}
}
...
func (*AltTimeChecks) Descriptor() ([]byte, []int) {
	return fileDescriptor_ea785983d34bd566, []int{4}
}
...
func (*UserRoyalties) Descriptor() ([]byte, []int) {
	return fileDescriptor_ea785983d34bd566, []int{5}
}
...
func init() {
	proto.RegisterType((*CoinTransfer)(nil), "tokenization.v25.CoinTransfer")
	proto.RegisterType((*MustOwnTokens)(nil), "tokenization.v25.MustOwnTokens")
	proto.RegisterType((*DynamicStoreChallenge)(nil), "tokenization.v25.DynamicStoreChallenge")
	proto.RegisterType((*AddressChecks)(nil), "tokenization.v25.AddressChecks")
	proto.RegisterType((*AltTimeChecks)(nil), "tokenization.v25.AltTimeChecks")
	proto.RegisterType((*UserRoyalties)(nil), "tokenization.v25.UserRoyalties")
}

func init() {
	proto.RegisterFile("tokenization/v25/approval_conditions.proto", fileDescriptor_ea785983d34bd566)
}

var fileDescriptor_ea785983d34bd566 = []byte{
	...
	0x82, 0xc8, 0x6e, 0x1b, 0xa9, 0x7a, 0xa0, 0x48, 0x9a, 0x5a, 0x5a, 0xf0, 0xa7, 0x6c, 0x53, 0x05,
	...
	0xc8, 0x87, 0xbf, 0x03, 0x00, 0x00, 0xff, 0xff, 0x4d, 0x17, 0x45, 0xc8, 0xba, 0x05, 0x00, 0x00,
}
