...
// source: tokenization/v25/approval_criteria.proto
...
func (*ApprovalCriteria) Descriptor() ([]byte, []int) {
	return fileDescriptor_5c7d9e437e8e5bf3, []int{0}
}
...
func (*OutgoingApprovalCriteria) Descriptor() ([]byte, []int) {
	return fileDescriptor_5c7d9e437e8e5bf3, []int{1}
}
...
func (*IncomingApprovalCriteria) Descriptor() ([]byte, []int) {
	return fileDescriptor_5c7d9e437e8e5bf3, []int{2}
}
...
func init() {
	proto.RegisterType((*ApprovalCriteria)(nil), "tokenization.v25.ApprovalCriteria")
	proto.RegisterType((*OutgoingApprovalCriteria)(nil), "tokenization.v25.OutgoingApprovalCriteria")
	proto.RegisterType((*IncomingApprovalCriteria)(nil), "tokenization.v25.IncomingApprovalCriteria")
}

func init() {
	proto.RegisterFile("tokenization/v25/approval_criteria.proto", fileDescriptor_5c7d9e437e8e5bf3)
}

var fileDescriptor_5c7d9e437e8e5bf3 = []byte{
	...
	,
}
