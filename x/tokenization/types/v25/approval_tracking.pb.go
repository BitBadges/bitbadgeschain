...
// source: tokenization/v25/approval_tracking.proto
...
func (*AutoDeletionOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_889a3980bcc74c3a, []int{0}
}
...
func (*ResetTimeIntervals) Descriptor() ([]byte, []int) {
	return fileDescriptor_889a3980bcc74c3a, []int{1}
}
...
func (*ApprovalAmounts) Descriptor() ([]byte, []int) {
	return fileDescriptor_889a3980bcc74c3a, []int{2}
}
...
func (*MaxNumTransfers) Descriptor() ([]byte, []int) {
	return fileDescriptor_889a3980bcc74c3a, []int{3}
}
...
func (*ApprovalTracker) Descriptor() ([]byte, []int) {
	return fileDescriptor_889a3980bcc74c3a, []int{4}
}
...
func init() {
	proto.RegisterType((*AutoDeletionOptions)(nil), "tokenization.v25.AutoDeletionOptions")
	proto.RegisterType((*ResetTimeIntervals)(nil), "tokenization.v25.ResetTimeIntervals")
	proto.RegisterType((*ApprovalAmounts)(nil), "tokenization.v25.ApprovalAmounts")
	proto.RegisterType((*MaxNumTransfers)(nil), "tokenization.v25.MaxNumTransfers")
	proto.RegisterType((*ApprovalTracker)(nil), "tokenization.v25.ApprovalTracker")
}

func init() {
	proto.RegisterFile("tokenization/v25/approval_tracking.proto", fileDescriptor_889a3980bcc74c3a)
}

var fileDescriptor_889a3980bcc74c3a = []byte{
	...
	,
}
