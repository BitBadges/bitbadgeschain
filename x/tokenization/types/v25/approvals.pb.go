...
// source: tokenization/v25/approvals.proto
...
func (*CollectionApproval) Descriptor() ([]byte, []int) {
	return fileDescriptor_eebddd122a666481, []int{0}
}
...
func (*UserOutgoingApproval) Descriptor() ([]byte, []int) {
	return fileDescriptor_eebddd122a666481, []int{1}
}
...
func (*UserIncomingApproval) Descriptor() ([]byte, []int) {
	return fileDescriptor_eebddd122a666481, []int{2}
}
...
func (*ApprovalIdentifierDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_eebddd122a666481, []int{3}
}
...
func init() {
	proto.RegisterType((*CollectionApproval)(nil), "tokenization.v25.CollectionApproval")
	proto.RegisterType((*UserOutgoingApproval)(nil), "tokenization.v25.UserOutgoingApproval")
	proto.RegisterType((*UserIncomingApproval)(nil), "tokenization.v25.UserIncomingApproval")
	proto.RegisterType((*ApprovalIdentifierDetails)(nil), "tokenization.v25.ApprovalIdentifierDetails")
}

func init() { proto.RegisterFile("tokenization/v25/approvals.proto", fileDescriptor_eebddd122a666481) }

var fileDescriptor_eebddd122a666481 = []byte{
	...
	0x43, 0x8c, 0x61, 0x13, 0x4c, 0xe3, 0xc5, 0x0b, 0xd0, 0x0b, 0x49, 0xa3, 0x09, 0xb1, 0x3d, 0x78,
	...
	0x00, 0x00, 0x00, 0xff, 0xff, 0x9d, 0xfb, 0x8b, 0x54, 0xa7, 0x07, 0x00, 0x00,
}
