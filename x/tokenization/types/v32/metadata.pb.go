...
// source: tokenization/v32/metadata.proto
...
func (*TokenMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb0ca974ef1fcd32, []int{0}
}
...
func (*CollectionMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb0ca974ef1fcd32, []int{1}
}
...
func (*PathMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb0ca974ef1fcd32, []int{2}
}
...
func init() {
	proto.RegisterType((*TokenMetadata)(nil), "tokenization.v32.TokenMetadata")
	proto.RegisterType((*CollectionMetadata)(nil), "tokenization.v32.CollectionMetadata")
	proto.RegisterType((*PathMetadata)(nil), "tokenization.v32.PathMetadata")
}

func init() { proto.RegisterFile("tokenization/v32/metadata.proto", fileDescriptor_cb0ca974ef1fcd32) }

var fileDescriptor_cb0ca974ef1fcd32 = []byte{
	...
	0xd6, 0xcc, 0x81, 0x0c, 0x5a, 0x31, 0x0d, 0x03, 0x91, 0x2b, 0x82, 0x04, 0x08, 0xfc, 0xf1, 0x04,
	0x09, 0xdd, 0xde, 0xba, 0xe0, 0x4f, 0xc3, 0x60, 0x70, 0xa4, 0x11, 0x75, 0xa6, 0x44, 0xdb, 0x97,
	...
	0x36, 0xe4, 0xf0, 0x2b, 0x00, 0x00, 0xff, 0xff, 0xca, 0xa5, 0x18, 0x3d, 0xeb, 0x01, 0x00, 0x00,
}
