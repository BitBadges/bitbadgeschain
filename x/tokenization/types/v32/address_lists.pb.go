...
// source: tokenization/v32/address_lists.proto
...
func (*AddressList) Descriptor() ([]byte, []int) {
	return fileDescriptor_3cdd580185db3e4c, []int{0}
}
...
func (*AddressListInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_3cdd580185db3e4c, []int{1}
}
...
func init() {
	proto.RegisterType((*AddressList)(nil), "tokenization.v32.AddressList")
	proto.RegisterType((*AddressListInput)(nil), "tokenization.v32.AddressListInput")
}

func init() {
	proto.RegisterFile("tokenization/v32/address_lists.proto", fileDescriptor_3cdd580185db3e4c)
}

var fileDescriptor_3cdd580185db3e4c = []byte{
	...
	0x00, 0xff, 0xff, 0x87, 0xba, 0x81, 0x7b, 0x1e, 0x02, 0x00, 0x00,
}
