...
// source: tokenization/v32/dynamic_stores.proto
...
func (*DynamicStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_44a96b37be50fa65, []int{0}
}
...
func (*DynamicStoreValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_44a96b37be50fa65, []int{1}
}
...
func init() {
	proto.RegisterType((*DynamicStore)(nil), "tokenization.v32.DynamicStore")
	proto.RegisterType((*DynamicStoreValue)(nil), "tokenization.v32.DynamicStoreValue")
}

func init() {
	proto.RegisterFile("tokenization/v32/dynamic_stores.proto", fileDescriptor_44a96b37be50fa65)
}

var fileDescriptor_44a96b37be50fa65 = []byte{
	...
	0x29, 0x4d, 0x5a, 0xaa, 0x57, 0xb5, 0xf5, 0x0c, 0x7f, 0x03, 0x00, 0x00, 0xff, 0xff, 0x92, 0x5d,
	0x13, 0xa2, 0xef, 0x01, 0x00, 0x00,
}
