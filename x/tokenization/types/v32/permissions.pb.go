...
// source: tokenization/v32/permissions.proto
...
func (*CollectionPermissions) Descriptor() ([]byte, []int) {
	return fileDescriptor_0da7ae8e716df278, []int{0}
}
...
func (*UserPermissions) Descriptor() ([]byte, []int) {
	return fileDescriptor_0da7ae8e716df278, []int{1}
}
...
func (*CollectionApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0da7ae8e716df278, []int{2}
}
...
func (*UserOutgoingApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0da7ae8e716df278, []int{3}
}
...
func (*UserIncomingApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0da7ae8e716df278, []int{4}
}
...
func (*TokenIdsActionPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0da7ae8e716df278, []int{5}
}
...
func (*ActionPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_0da7ae8e716df278, []int{6}
}
...
func init() {
	proto.RegisterType((*CollectionPermissions)(nil), "tokenization.v32.CollectionPermissions")
	proto.RegisterType((*UserPermissions)(nil), "tokenization.v32.UserPermissions")
	proto.RegisterType((*CollectionApprovalPermission)(nil), "tokenization.v32.CollectionApprovalPermission")
	proto.RegisterType((*UserOutgoingApprovalPermission)(nil), "tokenization.v32.UserOutgoingApprovalPermission")
	proto.RegisterType((*UserIncomingApprovalPermission)(nil), "tokenization.v32.UserIncomingApprovalPermission")
	proto.RegisterType((*TokenIdsActionPermission)(nil), "tokenization.v32.TokenIdsActionPermission")
	proto.RegisterType((*ActionPermission)(nil), "tokenization.v32.ActionPermission")
}

func init() {
	proto.RegisterFile("tokenization/v32/permissions.proto", fileDescriptor_0da7ae8e716df278)
}

var fileDescriptor_0da7ae8e716df278 = []byte{
	...
	0x37, 0x36, 0x68, 0x2b, 0xfe, 0x1d, 0x61, 0xf4, 0x47, 0xa4, 0x28, 0x67, 0xe6, 0xfc, 0xac, 0x6b,
	0x7a, 0x44, 0x4c, 0xa9, 0x94, 0x94, 0x33, 0xd9, 0xf1, 0x04, 0x57, 0x1c, 0x1e, 0xaf, 0xd6, 0x74,
	0xe6, 0x67, 0xdd, 0xd6, 0x0b, 0x87, 0x73, 0xc7, 0x25, 0x66, 0x70, 0x6f, 0xcd, 0xc6, 0x26, 0x62,
	...
	0x00, 0x00, 0xff, 0xff, 0x3b, 0xf0, 0x97, 0x8b, 0xe1, 0x0f, 0x00, 0x00,
}
