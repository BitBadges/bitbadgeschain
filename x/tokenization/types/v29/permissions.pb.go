...
// source: tokenization/v29/permissions.proto
...
func (*CollectionPermissions) Descriptor() ([]byte, []int) {
	return fileDescriptor_5423cbeefe93fa74, []int{0}
}
...
func (*UserPermissions) Descriptor() ([]byte, []int) {
	return fileDescriptor_5423cbeefe93fa74, []int{1}
}
...
func (*CollectionApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_5423cbeefe93fa74, []int{2}
}
...
func (*UserOutgoingApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_5423cbeefe93fa74, []int{3}
}
...
func (*UserIncomingApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_5423cbeefe93fa74, []int{4}
}
...
func (*TokenIdsActionPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_5423cbeefe93fa74, []int{5}
}
...
func (*ActionPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_5423cbeefe93fa74, []int{6}
}
...
func init() {
	proto.RegisterType((*CollectionPermissions)(nil), "tokenization.v29.CollectionPermissions")
	proto.RegisterType((*UserPermissions)(nil), "tokenization.v29.UserPermissions")
	proto.RegisterType((*CollectionApprovalPermission)(nil), "tokenization.v29.CollectionApprovalPermission")
	proto.RegisterType((*UserOutgoingApprovalPermission)(nil), "tokenization.v29.UserOutgoingApprovalPermission")
	proto.RegisterType((*UserIncomingApprovalPermission)(nil), "tokenization.v29.UserIncomingApprovalPermission")
	proto.RegisterType((*TokenIdsActionPermission)(nil), "tokenization.v29.TokenIdsActionPermission")
	proto.RegisterType((*ActionPermission)(nil), "tokenization.v29.ActionPermission")
}

func init() {
	proto.RegisterFile("tokenization/v29/permissions.proto", fileDescriptor_5423cbeefe93fa74)
}

var fileDescriptor_5423cbeefe93fa74 = []byte{
	...
	,
}
