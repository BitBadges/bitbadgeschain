...
// source: tokenization/v29/address_lists.proto
...
func (*AddressList) Descriptor() ([]byte, []int) {
	return fileDescriptor_29fb9e3c2bd3ebfc, []int{0}
}
...
func (*AddressListInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_29fb9e3c2bd3ebfc, []int{1}
}
...
func init() {
	proto.RegisterType((*AddressList)(nil), "tokenization.v29.AddressList")
	proto.RegisterType((*AddressListInput)(nil), "tokenization.v29.AddressListInput")
}

func init() {
	proto.RegisterFile("tokenization/v29/address_lists.proto", fileDescriptor_29fb9e3c2bd3ebfc)
}

var fileDescriptor_29fb9e3c2bd3ebfc = []byte{
	...
	0x9c, 0xd5, 0x81, 0x8d, 0x87, 0xcd, 0x81, 0x55, 0x0a, 0x0b, 0x1b, 0xd9, 0x24, 0x4b, 0xb2, 0x78,
	...
	0xff, 0xff, 0xc0, 0x75, 0xbc, 0x9b, 0x1e, 0x02, 0x00, 0x00,
}
