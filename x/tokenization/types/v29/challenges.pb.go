...
// source: tokenization/v29/challenges.proto
...
func (*MerkleChallenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_14389bbfc4dbefe1, []int{0}
}
...
func (*ETHSignatureChallenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_14389bbfc4dbefe1, []int{1}
}
...
func (*MerklePathItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_14389bbfc4dbefe1, []int{2}
}
...
func (*MerkleProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_14389bbfc4dbefe1, []int{3}
}
...
func (*ETHSignatureProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_14389bbfc4dbefe1, []int{4}
}
...
type VotingChallenge struct {
	...
	ResetAfterExecution bool `protobuf:"varint,6,opt,name=resetAfterExecution,proto3" json:"resetAfterExecution,omitempty"`
	...
	DelayAfterQuorum Uint `protobuf:"bytes,7,opt,name=delayAfterQuorum,proto3,customtype=Uint" json:"delayAfterQuorum"`
}
...
func (*VotingChallenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_14389bbfc4dbefe1, []int{5}
}
...
func (m *VotingChallenge) GetResetAfterExecution() bool {
	if m != nil {
		return m.ResetAfterExecution
	}
	return false
}
...
func (*Voter) Descriptor() ([]byte, []int) {
	return fileDescriptor_14389bbfc4dbefe1, []int{6}
}
...
type VoteProof struct {
	...
	VotedAt Uint `protobuf:"bytes,4,opt,name=votedAt,proto3,customtype=Uint" json:"votedAt"`
}
...
func (*VoteProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_14389bbfc4dbefe1, []int{7}
}
...
type VotingChallengeTracker struct {
	// Timestamp (unix ms) when quorum was first reached. Cleared when quorum drops or after reset.
	QuorumReachedTimestamp Uint `protobuf:"bytes,1,opt,name=quorumReachedTimestamp,proto3,customtype=Uint" json:"quorumReachedTimestamp"`
}

func (m *VotingChallengeTracker) Reset()         { *m = VotingChallengeTracker{} }
func (m *VotingChallengeTracker) String() string { return proto.CompactTextString(m) }
func (*VotingChallengeTracker) ProtoMessage()    {}
func (*VotingChallengeTracker) Descriptor() ([]byte, []int) {
	return fileDescriptor_14389bbfc4dbefe1, []int{8}
}
func (m *VotingChallengeTracker) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VotingChallengeTracker) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VotingChallengeTracker.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VotingChallengeTracker) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VotingChallengeTracker.Merge(m, src)
}
func (m *VotingChallengeTracker) XXX_Size() int {
	return m.Size()
}
func (m *VotingChallengeTracker) XXX_DiscardUnknown() {
	xxx_messageInfo_VotingChallengeTracker.DiscardUnknown(m)
}

var xxx_messageInfo_VotingChallengeTracker proto.InternalMessageInfo
...
type EVMQueryChallenge struct {
	...
	ComparisonOperator string `protobuf:"bytes,4,opt,name=comparisonOperator,proto3" json:"comparisonOperator,omitempty"`
	// Gas limit for the query (default 100000, max 500000)
	GasLimit Uint `protobuf:"bytes,5,opt,name=gasLimit,proto3,customtype=Uint" json:"gasLimit"`
...
func (m *EVMQueryChallenge) Reset()         { *m = EVMQueryChallenge{} }
func (m *EVMQueryChallenge) String() string { return proto.CompactTextString(m) }
func (*EVMQueryChallenge) ProtoMessage()    {}
func (*EVMQueryChallenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_14389bbfc4dbefe1, []int{9}
}
func (m *EVMQueryChallenge) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EVMQueryChallenge) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EVMQueryChallenge.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EVMQueryChallenge) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EVMQueryChallenge.Merge(m, src)
}
func (m *EVMQueryChallenge) XXX_Size() int {
	return m.Size()
}
func (m *EVMQueryChallenge) XXX_DiscardUnknown() {
	xxx_messageInfo_EVMQueryChallenge.DiscardUnknown(m)
}

var xxx_messageInfo_EVMQueryChallenge proto.InternalMessageInfo

func (m *EVMQueryChallenge) GetContractAddress() string {
	if m != nil {
...
func (m *EVMQueryChallenge) GetCalldata() string {
	if m != nil {
		return m.Calldata
	}
	return ""
...
func (m *EVMQueryChallenge) GetExpectedResult() string {
	if m != nil {
...
func (m *EVMQueryChallenge) GetComparisonOperator() string {
	if m != nil {
...
func (m *EVMQueryChallenge) GetUri() string {
	if m != nil {
		return m.Uri
	}
	return ""
...
func (m *EVMQueryChallenge) GetCustomData() string {
	if m != nil {
		return m.CustomData
	}
	return ""
...
func init() {
	proto.RegisterType((*MerkleChallenge)(nil), "tokenization.v29.MerkleChallenge")
	proto.RegisterType((*ETHSignatureChallenge)(nil), "tokenization.v29.ETHSignatureChallenge")
	proto.RegisterType((*MerklePathItem)(nil), "tokenization.v29.MerklePathItem")
	proto.RegisterType((*MerkleProof)(nil), "tokenization.v29.MerkleProof")
	proto.RegisterType((*ETHSignatureProof)(nil), "tokenization.v29.ETHSignatureProof")
	proto.RegisterType((*VotingChallenge)(nil), "tokenization.v29.VotingChallenge")
	proto.RegisterType((*Voter)(nil), "tokenization.v29.Voter")
	proto.RegisterType((*VoteProof)(nil), "tokenization.v29.VoteProof")
	proto.RegisterType((*VotingChallengeTracker)(nil), "tokenization.v29.VotingChallengeTracker")
	proto.RegisterType((*EVMQueryChallenge)(nil), "tokenization.v29.EVMQueryChallenge")
}

func init() { proto.RegisterFile("tokenization/v29/challenges.proto", fileDescriptor_14389bbfc4dbefe1) }

var fileDescriptor_14389bbfc4dbefe1 = []byte{
	// 822 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *VotingChallenge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.DelayAfterQuorum.Size()
		i -= size
		if _, err := m.DelayAfterQuorum.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintChallenges(dAtA, i, uint64(size))
	}
...
func (m *VoteProof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.VotedAt.Size()
		i -= size
		if _, err := m.VotedAt.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintChallenges(dAtA, i, uint64(size))
	}
...
func (m *VotingChallengeTracker) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VotingChallengeTracker) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VotingChallengeTracker) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size := m.QuorumReachedTimestamp.Size()
		i -= size
		if _, err := m.QuorumReachedTimestamp.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintChallenges(dAtA, i, uint64(size))
	}
...
func (m *EVMQueryChallenge) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EVMQueryChallenge) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EVMQueryChallenge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ComparisonOperator) > 0 {
		...
		i = encodeVarintChallenges(dAtA, i, uint64(len(m.ComparisonOperator)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.ExpectedResult) > 0 {
		...
		i = encodeVarintChallenges(dAtA, i, uint64(len(m.ExpectedResult)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Calldata) > 0 {
		...
		i = encodeVarintChallenges(dAtA, i, uint64(len(m.Calldata)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ContractAddress) > 0 {
		...
		i = encodeVarintChallenges(dAtA, i, uint64(len(m.ContractAddress)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *VotingChallengeTracker) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.QuorumReachedTimestamp.Size()
	n += 1 + l + sovChallenges(uint64(l))
	return n
}

func (m *EVMQueryChallenge) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VotingChallenge) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResetAfterExecution", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ResetAfterExecution = bool(v != 0)
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelayAfterQuorum", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.DelayAfterQuorum.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *VoteProof) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.VotedAt.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *VotingChallengeTracker) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VotingChallengeTracker: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VotingChallengeTracker: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QuorumReachedTimestamp", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.QuorumReachedTimestamp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *EVMQueryChallenge) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EVMQueryChallenge: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EVMQueryChallenge: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
