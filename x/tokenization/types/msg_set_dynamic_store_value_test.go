...
func TestMsgSetDynamicStoreValue_ValidateBasic(t *testing.T) {
	...
	msg = NewMsgSetDynamicStoreValue("bb1jmjfq0tplp9tmx4v9uemw72y4d2wa5nrjmmk3q", sdkmath.NewUint(1), "bb1jmjfq0tplp9tmx4v9uemw72y4d2wa5nrjmmk3q", sdkmath.NewUint(100))
	require.NoError(t, msg.ValidateBasic())

	// Test with zero value
	msg = NewMsgSetDynamicStoreValue("bb1jmjfq0tplp9tmx4v9uemw72y4d2wa5nrjmmk3q", sdkmath.NewUint(1), "bb1jmjfq0tplp9tmx4v9uemw72y4d2wa5nrjmmk3q", sdkmath.NewUint(0))
	require.NoError(t, msg.ValidateBasic())
}
