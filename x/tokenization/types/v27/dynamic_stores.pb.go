...
// source: tokenization/v27/dynamic_stores.proto
...
func (*DynamicStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_b84c9f96ff6a41c2, []int{0}
}
...
func (*DynamicStoreValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_b84c9f96ff6a41c2, []int{1}
}
...
func init() {
	proto.RegisterType((*DynamicStore)(nil), "tokenization.v27.DynamicStore")
	proto.RegisterType((*DynamicStoreValue)(nil), "tokenization.v27.DynamicStoreValue")
}

func init() {
	proto.RegisterFile("tokenization/v27/dynamic_stores.proto", fileDescriptor_b84c9f96ff6a41c2)
}

var fileDescriptor_b84c9f96ff6a41c2 = []byte{
	...
	0xc5, 0x25, 0x58, 0xd0, 0x58, 0x11, 0x2c, 0x6c, 0x31, 0x52, 0xd8, 0x98, 0xbd, 0xdb, 0xf5, 0xd8,
	...
	0xff, 0x8c, 0x59, 0xe4, 0x0d, 0xef, 0x01, 0x00, 0x00,
}
