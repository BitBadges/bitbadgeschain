...
// source: tokenization/v27/timelines.proto
...
func (*CollectionMetadataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_55ae4c7e41d3680c, []int{0}
}
...
func (*TokenMetadataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_55ae4c7e41d3680c, []int{1}
}
...
func (*CustomDataTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_55ae4c7e41d3680c, []int{2}
}
...
func (*ManagerTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_55ae4c7e41d3680c, []int{3}
}
...
func (*IsArchivedTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_55ae4c7e41d3680c, []int{4}
}
...
func (*ContractAddressTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_55ae4c7e41d3680c, []int{5}
}
...
func (*StandardsTimeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_55ae4c7e41d3680c, []int{6}
}
...
func init() {
	proto.RegisterType((*CollectionMetadataTimeline)(nil), "tokenization.v27.CollectionMetadataTimeline")
	proto.RegisterType((*TokenMetadataTimeline)(nil), "tokenization.v27.TokenMetadataTimeline")
	proto.RegisterType((*CustomDataTimeline)(nil), "tokenization.v27.CustomDataTimeline")
	proto.RegisterType((*ManagerTimeline)(nil), "tokenization.v27.ManagerTimeline")
	proto.RegisterType((*IsArchivedTimeline)(nil), "tokenization.v27.IsArchivedTimeline")
	proto.RegisterType((*ContractAddressTimeline)(nil), "tokenization.v27.ContractAddressTimeline")
	proto.RegisterType((*StandardsTimeline)(nil), "tokenization.v27.StandardsTimeline")
}

func init() { proto.RegisterFile("tokenization/v27/timelines.proto", fileDescriptor_55ae4c7e41d3680c) }

var fileDescriptor_55ae4c7e41d3680c = []byte{
	...
	0xbc, 0x52, 0x28, 0xae, 0xa1, 0x09, 0x81, 0x82, 0xe2, 0x1a, 0x13, 0x28, 0xe8, 0xc6, 0xeb, 0xbd,
	...
	0xb8, 0x0d, 0xaf, 0xfe, 0x07, 0x00, 0x00, 0xff, 0xff, 0x86, 0x48, 0xfc, 0x09, 0x0a, 0x05, 0x00,
	0x00,
}
