...
// source: tokenization/v27/approval_tracking.proto
...
func (*AutoDeletionOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_03fb61e7305d0a41, []int{0}
}
...
func (*ResetTimeIntervals) Descriptor() ([]byte, []int) {
	return fileDescriptor_03fb61e7305d0a41, []int{1}
}
...
func (*ApprovalAmounts) Descriptor() ([]byte, []int) {
	return fileDescriptor_03fb61e7305d0a41, []int{2}
}
...
func (*MaxNumTransfers) Descriptor() ([]byte, []int) {
	return fileDescriptor_03fb61e7305d0a41, []int{3}
}
...
func (*ApprovalTracker) Descriptor() ([]byte, []int) {
	return fileDescriptor_03fb61e7305d0a41, []int{4}
}
...
func init() {
	proto.RegisterType((*AutoDeletionOptions)(nil), "tokenization.v27.AutoDeletionOptions")
	proto.RegisterType((*ResetTimeIntervals)(nil), "tokenization.v27.ResetTimeIntervals")
	proto.RegisterType((*ApprovalAmounts)(nil), "tokenization.v27.ApprovalAmounts")
	proto.RegisterType((*MaxNumTransfers)(nil), "tokenization.v27.MaxNumTransfers")
	proto.RegisterType((*ApprovalTracker)(nil), "tokenization.v27.ApprovalTracker")
}

func init() {
	proto.RegisterFile("tokenization/v27/approval_tracking.proto", fileDescriptor_03fb61e7305d0a41)
}

var fileDescriptor_03fb61e7305d0a41 = []byte{
	...
	,
}
