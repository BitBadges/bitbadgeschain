...
// source: tokenization/v27/address_lists.proto
...
func (*AddressList) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ef7b0906b799b61, []int{0}
}
...
func (*AddressListInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ef7b0906b799b61, []int{1}
}
...
func init() {
	proto.RegisterType((*AddressList)(nil), "tokenization.v27.AddressList")
	proto.RegisterType((*AddressListInput)(nil), "tokenization.v27.AddressListInput")
}

func init() {
	proto.RegisterFile("tokenization/v27/address_lists.proto", fileDescriptor_2ef7b0906b799b61)
}

var fileDescriptor_2ef7b0906b799b61 = []byte{
	...
	0x9c, 0xc5, 0x35, 0x36, 0x1e, 0x36, 0x07, 0x56, 0x29, 0x2c, 0x6c, 0x64, 0x93, 0x2c, 0xc9, 0xe2,
	...
	0x00, 0xff, 0xff, 0xd5, 0xe6, 0xb3, 0xfd, 0x1e, 0x02, 0x00, 0x00,
}
