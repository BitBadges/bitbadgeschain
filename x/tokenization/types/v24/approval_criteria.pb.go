...
// source: tokenization/v24/approval_criteria.proto
...
func (*ApprovalCriteria) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b03aeb895ec3930, []int{0}
}
...
func (*OutgoingApprovalCriteria) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b03aeb895ec3930, []int{1}
}
...
func (*IncomingApprovalCriteria) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b03aeb895ec3930, []int{2}
}
...
func init() {
	proto.RegisterType((*ApprovalCriteria)(nil), "tokenization.v24.ApprovalCriteria")
	proto.RegisterType((*OutgoingApprovalCriteria)(nil), "tokenization.v24.OutgoingApprovalCriteria")
	proto.RegisterType((*IncomingApprovalCriteria)(nil), "tokenization.v24.IncomingApprovalCriteria")
}

func init() {
	proto.RegisterFile("tokenization/v24/approval_criteria.proto", fileDescriptor_0b03aeb895ec3930)
}

var fileDescriptor_0b03aeb895ec3930 = []byte{
	...
	,
}
