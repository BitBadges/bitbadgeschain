...
// source: tokenization/transfers.proto
...
func (*Transfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_a37027d82c2edfa4, []int{0}
}
...
func (*PrecalculateBalancesFromApprovalDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_a37027d82c2edfa4, []int{1}
}
...
func init() {
	proto.RegisterType((*Transfer)(nil), "tokenization.Transfer")
	proto.RegisterType((*PrecalculateBalancesFromApprovalDetails)(nil), "tokenization.PrecalculateBalancesFromApprovalDetails")
}

func init() { proto.RegisterFile("tokenization/transfers.proto", fileDescriptor_a37027d82c2edfa4) }

var fileDescriptor_a37027d82c2edfa4 = []byte{
	// 578 bytes of a gzipped FileDescriptorProto
	,
}
