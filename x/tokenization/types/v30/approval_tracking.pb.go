...
// source: tokenization/v30/approval_tracking.proto
...
func (*AutoDeletionOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_68ca02860f86f6ab, []int{0}
}
...
func (*ResetTimeIntervals) Descriptor() ([]byte, []int) {
	return fileDescriptor_68ca02860f86f6ab, []int{1}
}
...
func (*ApprovalAmounts) Descriptor() ([]byte, []int) {
	return fileDescriptor_68ca02860f86f6ab, []int{2}
}
...
func (*MaxNumTransfers) Descriptor() ([]byte, []int) {
	return fileDescriptor_68ca02860f86f6ab, []int{3}
}
...
func (*ApprovalTracker) Descriptor() ([]byte, []int) {
	return fileDescriptor_68ca02860f86f6ab, []int{4}
}
...
func init() {
	proto.RegisterType((*AutoDeletionOptions)(nil), "tokenization.v30.AutoDeletionOptions")
	proto.RegisterType((*ResetTimeIntervals)(nil), "tokenization.v30.ResetTimeIntervals")
	proto.RegisterType((*ApprovalAmounts)(nil), "tokenization.v30.ApprovalAmounts")
	proto.RegisterType((*MaxNumTransfers)(nil), "tokenization.v30.MaxNumTransfers")
	proto.RegisterType((*ApprovalTracker)(nil), "tokenization.v30.ApprovalTracker")
}

func init() {
	proto.RegisterFile("tokenization/v30/approval_tracking.proto", fileDescriptor_68ca02860f86f6ab)
}

var fileDescriptor_68ca02860f86f6ab = []byte{
	...
	0xb7, 0xa1, 0xc6, 0x93, 0x07, 0x5b, 0xd1, 0xa4, 0x09, 0x02, 0xd9, 0x14, 0x0f, 0x1e, 0xd4, 0x69,
	...
	0x0b, 0xd5, 0x4c, 0x70, 0x37, 0xae, 0x55, 0x5d, 0x1a, 0x45, 0x52, 0xc4, 0x34, 0xfc, 0xa8, 0x25,
	0xed, 0x9c, 0x32, 0x1e, 0x54, 0x22, 0x29, 0xb4, 0x20, 0xf7, 0xc6, 0x91, 0x95, 0xb8, 0x56, 0x5d,
	...
	,
	...
	0xb9, 0x1d, 0xfe, 0x17, 0xa9, 0xc2, 0x32, 0xff, 0x97, 0xab, 0x13, 0x08, 0x52, 0x83, 0x85, 0xac,
	0xdd, 0xc4, 0xb7, 0x62, 0x79, 0x69, 0xe7, 0xe1, 0x74, 0x43, 0x8d, 0xec, 0x73, 0xec, 0xfd, 0x45,
	0x92, 0x1d, 0xb8, 0x13, 0x52, 0xa5, 0x8f, 0x22, 0x3f, 0x39, 0xa1, 0xba, 0x39, 0x7d, 0x93, 0x90,
	0xc6, 0xbb, 0x8b, 0xbe, 0x63, 0x5d, 0xf6, 0x1d, 0xeb, 0x77, 0xdf, 0xb1, 0xbe, 0x0e, 0x9c, 0xc2,
	0xe5, 0xc0, 0x29, 0xfc, 0x18, 0x38, 0x85, 0xf7, 0x2f, 0x02, 0xa6, 0x4f, 0x7a, 0xed, 0x4a, 0x47,
	0x74, 0xdd, 0x36, 0xd3, 0x6d, 0xea, 0x07, 0xa8, 0x46, 0xa3, 0xce, 0x09, 0x65, 0xdc, 0x3d, 0x73,
	0x27, 0x5e, 0x09, 0x7d, 0x1e, 0xa1, 0x4a, 0xde, 0x8a, 0xf6, 0x7c, 0xfa, 0x46, 0xd4, 0xfe, 0x04,
	0x00, 0x00, 0xff, 0xff, 0xdb, 0x6f, 0x38, 0xff, 0x98, 0x06, 0x00, 0x00,
}
