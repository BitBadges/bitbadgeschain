...
// source: tokenization/v30/address_lists.proto
...
func (*AddressList) Descriptor() ([]byte, []int) {
	return fileDescriptor_278c4cc9a97b304f, []int{0}
}
...
func (*AddressListInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_278c4cc9a97b304f, []int{1}
}
...
func init() {
	proto.RegisterType((*AddressList)(nil), "tokenization.v30.AddressList")
	proto.RegisterType((*AddressListInput)(nil), "tokenization.v30.AddressListInput")
}

func init() {
	proto.RegisterFile("tokenization/v30/address_lists.proto", fileDescriptor_278c4cc9a97b304f)
}

var fileDescriptor_278c4cc9a97b304f = []byte{
	...
	0xec, 0x41, 0x5a, 0x1b, 0x0f, 0x9b, 0x03, 0xab, 0x14, 0x16, 0x36, 0xb2, 0x49, 0x96, 0x64, 0xf1,
	...
	0xa0, 0x1e, 0x45, 0x21, 0x5f, 0x38, 0x48, 0x55, 0xb0, 0x6d, 0xb8, 0x60, 0x3c, 0x4d, 0x2b, 0xa1,
	0xf5, 0xc3, 0x5a, 0x6a, 0xd0, 0x41, 0x59, 0x29, 0x50, 0xae, 0x33, 0x76, 0x05, 0xdb, 0x70, 0x31,
	...
	0x00, 0xff, 0xff, 0xad, 0x89, 0x05, 0xa3, 0x1e, 0x02, 0x00, 0x00,
}
