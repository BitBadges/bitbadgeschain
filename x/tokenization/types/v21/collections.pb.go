...
// source: badges/v21/collections.proto
...
func (*TokenCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff08fd46771ebd35, []int{0}
}
...
func (*CosmosCoinWrapperPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff08fd46771ebd35, []int{1}
}
...
func (*CosmosCoinBackedPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff08fd46771ebd35, []int{2}
}
...
func (*DenomUnit) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff08fd46771ebd35, []int{3}
}
...
func (*CollectionInvariants) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff08fd46771ebd35, []int{4}
}
...
func init() {
	proto.RegisterType((*TokenCollection)(nil), "badges.v21.TokenCollection")
	proto.RegisterType((*CosmosCoinWrapperPath)(nil), "badges.v21.CosmosCoinWrapperPath")
	proto.RegisterType((*CosmosCoinBackedPath)(nil), "badges.v21.CosmosCoinBackedPath")
	proto.RegisterType((*DenomUnit)(nil), "badges.v21.DenomUnit")
	proto.RegisterType((*CollectionInvariants)(nil), "badges.v21.CollectionInvariants")
}

func init() { proto.RegisterFile("badges/v21/collections.proto", fileDescriptor_ff08fd46771ebd35) }

var fileDescriptor_ff08fd46771ebd35 = []byte{
	// 929 bytes of a gzipped FileDescriptorProto
	,
}
