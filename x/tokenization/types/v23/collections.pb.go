...
// source: tokenization/v23/collections.proto
...
func (*TokenCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab4d45c901e2c4ec, []int{0}
}
...
func (*Conversion) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab4d45c901e2c4ec, []int{1}
}
...
func (*ConversionSideAWithDenom) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab4d45c901e2c4ec, []int{2}
}
...
func (*ConversionWithoutDenom) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab4d45c901e2c4ec, []int{3}
}
...
func (*ConversionSideA) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab4d45c901e2c4ec, []int{4}
}
...
func (*CosmosCoinWrapperPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab4d45c901e2c4ec, []int{5}
}
...
func (*AliasPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab4d45c901e2c4ec, []int{6}
}
...
func (*CosmosCoinBackedPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab4d45c901e2c4ec, []int{7}
}
...
func (*DenomUnit) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab4d45c901e2c4ec, []int{8}
}
...
func (*CollectionInvariants) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab4d45c901e2c4ec, []int{9}
}
...
func init() {
	proto.RegisterType((*TokenCollection)(nil), "tokenization.v23.TokenCollection")
	proto.RegisterType((*Conversion)(nil), "tokenization.v23.Conversion")
	proto.RegisterType((*ConversionSideAWithDenom)(nil), "tokenization.v23.ConversionSideAWithDenom")
	proto.RegisterType((*ConversionWithoutDenom)(nil), "tokenization.v23.ConversionWithoutDenom")
	proto.RegisterType((*ConversionSideA)(nil), "tokenization.v23.ConversionSideA")
	proto.RegisterType((*CosmosCoinWrapperPath)(nil), "tokenization.v23.CosmosCoinWrapperPath")
	proto.RegisterType((*AliasPath)(nil), "tokenization.v23.AliasPath")
	proto.RegisterType((*CosmosCoinBackedPath)(nil), "tokenization.v23.CosmosCoinBackedPath")
	proto.RegisterType((*DenomUnit)(nil), "tokenization.v23.DenomUnit")
	proto.RegisterType((*CollectionInvariants)(nil), "tokenization.v23.CollectionInvariants")
}

func init() {
	proto.RegisterFile("tokenization/v23/collections.proto", fileDescriptor_ab4d45c901e2c4ec)
}

var fileDescriptor_ab4d45c901e2c4ec = []byte{
	...
	0xce, 0x2b, 0x86, 0xb8, 0x48, 0x86, 0x15, 0xd8, 0x7a, 0x51, 0xdb, 0x69, 0xb0, 0x00, 0x2b, 0x1a,
	...
	,
}
