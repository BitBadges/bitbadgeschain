...
// source: tokenization/v23/approval_tracking.proto
...
func (*AutoDeletionOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_999bd46851b99c2a, []int{0}
}
...
func (*ResetTimeIntervals) Descriptor() ([]byte, []int) {
	return fileDescriptor_999bd46851b99c2a, []int{1}
}
...
func (*ApprovalAmounts) Descriptor() ([]byte, []int) {
	return fileDescriptor_999bd46851b99c2a, []int{2}
}
...
func (*MaxNumTransfers) Descriptor() ([]byte, []int) {
	return fileDescriptor_999bd46851b99c2a, []int{3}
}
...
func (*ApprovalTracker) Descriptor() ([]byte, []int) {
	return fileDescriptor_999bd46851b99c2a, []int{4}
}
...
func init() {
	proto.RegisterType((*AutoDeletionOptions)(nil), "tokenization.v23.AutoDeletionOptions")
	proto.RegisterType((*ResetTimeIntervals)(nil), "tokenization.v23.ResetTimeIntervals")
	proto.RegisterType((*ApprovalAmounts)(nil), "tokenization.v23.ApprovalAmounts")
	proto.RegisterType((*MaxNumTransfers)(nil), "tokenization.v23.MaxNumTransfers")
	proto.RegisterType((*ApprovalTracker)(nil), "tokenization.v23.ApprovalTracker")
}

func init() {
	proto.RegisterFile("tokenization/v23/approval_tracking.proto", fileDescriptor_999bd46851b99c2a)
}

var fileDescriptor_999bd46851b99c2a = []byte{
	...
	,
}
