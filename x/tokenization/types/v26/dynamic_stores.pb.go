...
// source: tokenization/v26/dynamic_stores.proto
...
func (*DynamicStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_0762a14a0bfaf9a9, []int{0}
}
...
func (*DynamicStoreValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_0762a14a0bfaf9a9, []int{1}
}
...
func init() {
	proto.RegisterType((*DynamicStore)(nil), "tokenization.v26.DynamicStore")
	proto.RegisterType((*DynamicStoreValue)(nil), "tokenization.v26.DynamicStoreValue")
}

func init() {
	proto.RegisterFile("tokenization/v26/dynamic_stores.proto", fileDescriptor_0762a14a0bfaf9a9)
}

var fileDescriptor_0762a14a0bfaf9a9 = []byte{
	...
	0x3c, 0x30, 0x60, 0x95, 0x4a, 0x4c, 0x91, 0xd6, 0x10, 0x8b, 0x34, 0x61, 0xef, 0x76, 0x73, 0x2e,
	...
	0xf5, 0x03, 0x1c, 0x4b, 0xef, 0x01, 0x00, 0x00,
}
