...
// source: tokenization/v26/permissions.proto
...
func (*CollectionPermissions) Descriptor() ([]byte, []int) {
	return fileDescriptor_54b120e22c36ca8f, []int{0}
}
...
func (*UserPermissions) Descriptor() ([]byte, []int) {
	return fileDescriptor_54b120e22c36ca8f, []int{1}
}
...
func (*CollectionApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_54b120e22c36ca8f, []int{2}
}
...
func (*UserOutgoingApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_54b120e22c36ca8f, []int{3}
}
...
func (*UserIncomingApprovalPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_54b120e22c36ca8f, []int{4}
}
...
func (*TokenIdsActionPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_54b120e22c36ca8f, []int{5}
}
...
func (*ActionPermission) Descriptor() ([]byte, []int) {
	return fileDescriptor_54b120e22c36ca8f, []int{6}
}
...
func init() {
	proto.RegisterType((*CollectionPermissions)(nil), "tokenization.v26.CollectionPermissions")
	proto.RegisterType((*UserPermissions)(nil), "tokenization.v26.UserPermissions")
	proto.RegisterType((*CollectionApprovalPermission)(nil), "tokenization.v26.CollectionApprovalPermission")
	proto.RegisterType((*UserOutgoingApprovalPermission)(nil), "tokenization.v26.UserOutgoingApprovalPermission")
	proto.RegisterType((*UserIncomingApprovalPermission)(nil), "tokenization.v26.UserIncomingApprovalPermission")
	proto.RegisterType((*TokenIdsActionPermission)(nil), "tokenization.v26.TokenIdsActionPermission")
	proto.RegisterType((*ActionPermission)(nil), "tokenization.v26.ActionPermission")
}

func init() {
	proto.RegisterFile("tokenization/v26/permissions.proto", fileDescriptor_54b120e22c36ca8f)
}

var fileDescriptor_54b120e22c36ca8f = []byte{
	...
	0x15, 0x42, 0x31, 0x0a, 0xd2, 0x63, 0xc3, 0x26, 0x2f, 0x15, 0x52, 0x24, 0x0a, 0x55, 0x9a, 0x16,
	...
	0x04, 0x00, 0x00, 0xff, 0xff, 0x0f, 0xf2, 0x1d, 0x88, 0xe1, 0x0f, 0x00, 0x00,
}
