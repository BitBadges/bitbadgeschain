...
func TestMsgDeleteIncomingApproval_ValidateBasic_InvalidCreator(t *testing.T) {
...
func TestMsgDeleteIncomingApproval_ValidateBasic_NilCollectionId(t *testing.T) {
	msg := &types.MsgDeleteIncomingApproval{
...
func TestMsgDeleteIncomingApproval_ValidateBasic_ZeroCollectionId(t *testing.T) {
	msg := &types.MsgDeleteIncomingApproval{
		Creator:      "bb1e0w5t53nrq7p66fye6c8p0ynyhf6y24lke5430",
...
func TestMsgDeleteIncomingApproval_ValidateBasic_EmptyApprovalId(t *testing.T) {
	msg := &types.MsgDeleteIncomingApproval{
		Creator:      "bb1e0w5t53nrq7p66fye6c8p0ynyhf6y24lke5430",
		CollectionId: sdkmath.NewUint(1),
		ApprovalId:   "",
...
func TestMsgDeleteIncomingApproval_ValidateBasic_Valid(t *testing.T) {
	msg := &types.MsgDeleteIncomingApproval{
		Creator:      "bb1e0w5t53nrq7p66fye6c8p0ynyhf6y24lke5430",
		CollectionId: sdkmath.NewUint(1),
		ApprovalId:   "test_approval",
