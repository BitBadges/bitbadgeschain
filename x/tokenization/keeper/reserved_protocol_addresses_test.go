...
func (suite *TestSuite) TestReservedProtocolAddressCosmosCoinWrapperPath() {
	...
	isReservedProtocol := suite.app.TokenizationKeeper.IsAddressReservedProtocolInStore(suite.ctx, wrapperPathAddress)
...
func (suite *TestSuite) TestReservedProtocolAddressGammPool() {
	...
	// Verify the address is reservedProtocol
	isReservedProtocol := suite.app.TokenizationKeeper.IsAddressReservedProtocolInStore(suite.ctx, poolAddress)
...
func (suite *TestSuite) TestReservedProtocolAddressGovernanceSetUnset() {
	...
	isReservedProtocol := suite.app.TokenizationKeeper.IsAddressReservedProtocolInStore(suite.ctx, testAddress)
...
func (suite *TestSuite) TestReservedProtocolAddressGetAll() {
	...
	allReservedProtocol := suite.app.TokenizationKeeper.GetAllReservedProtocolAddressesFromStore(suite.ctx)
