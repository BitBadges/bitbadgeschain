...
func (suite *TestSuite) TestNoMerkleChallengeWorking() {
	...
	_, err := suite.app.TokenizationKeeper.DeductCollectionApprovalsAndGetUserApprovalsToCheck(
		suite.ctx,
		collection,
		&types.Transfer{
			From:        bob,
...
func (suite *TestSuite) TestETHSignatureChallenge_TrackerQuery() {
	...
	response, err := suite.app.TokenizationKeeper.GetETHSignatureTracker(
		wctx,
