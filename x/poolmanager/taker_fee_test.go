...
// 			exactIn:        true,
// 			expectedResult: sdk.NewCoin(apptesting.ETH, defaultAmount), // No taker fee charged
// 		},
...
// 			// Since taker fees are disabled in this fork, we expect no taker fees to be taken
// 			s.Require().Equal(tc.tokenIn, tokenInAfterTakerFee, "taker fees should not be charged")
