...
func (suite *TestSuite) TestForceUpdateDisallowed() {
	wctx := sdk.WrapSDKContext(suite.ctx)
	createMsg := GetDefaultCreateMsg()
...
func (suite *TestSuite) TestForceUpdateAllowed() {
	wctx := sdk.WrapSDKContext(suite.ctx)
	createMsg := GetDefaultCreateMsg()
	createMsg.UpdateCriteria.ManagerOnly = false
	createMsg.UpdateCriteria.CreatorOnly = true
...
func (suite *TestSuite) TestForceUpdateAllowedDefaultValues() {
	wctx := sdk.WrapSDKContext(suite.ctx)
	createMsg := GetDefaultCreateMsg()
	createMsg.UpdateCriteria.ManagerOnly = false
	createMsg.UpdateCriteria.CreatorOnly = true
...
func (suite *TestSuite) TestIsNotEditable() {
	wctx := sdk.WrapSDKContext(suite.ctx)
	createMsg := GetDefaultCreateMsg()
...
func (suite *TestSuite) TestLockSpecificKey() {
	wctx := sdk.WrapSDKContext(suite.ctx)
	createMsg := GetDefaultCreateMsg()
	createMsg.UpdateCriteria.ManagerOnly = false
...
func (suite *TestSuite) TestLockAllButSpecificKey() {
	wctx := sdk.WrapSDKContext(suite.ctx)
	createMsg := GetDefaultCreateMsg()
	createMsg.UpdateCriteria.ManagerOnly = false
	createMsg.UpdateCriteria.CreatorOnly = false
